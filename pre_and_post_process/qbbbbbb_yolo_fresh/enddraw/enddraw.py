...
os.system("gcc -o yolo0_inter yolo0_main.c yolo0.h")
os.system("./yolo0_inter")
# interleave_output_group-yolo1
os.system("gcc -o yolo1_inter yolo1_main.c yolo1.h")
os.system("./yolo1_inter")
