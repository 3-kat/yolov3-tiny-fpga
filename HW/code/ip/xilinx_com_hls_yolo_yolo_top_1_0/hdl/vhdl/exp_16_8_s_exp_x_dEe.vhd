...
entity exp_16_8_s_exp_x_dEe_rom is 
    generic(
             DWIDTH     : integer := 25; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of exp_16_8_s_exp_x_dEe_rom is 
...
entity exp_16_8_s_exp_x_dEe is
    generic (
...
architecture arch of exp_16_8_s_exp_x_dEe is
    component exp_16_8_s_exp_x_dEe_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    exp_16_8_s_exp_x_dEe_rom_U :  component exp_16_8_s_exp_x_dEe_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
