<AutoPilot:project xmlns:AutoPilot="com.autoesl.autopilot.project" projectType="C/C++" name="yolo_acc_prj" top="yolo_acc_top">
    <includePaths/>
    <libraryFlag/>
    <files>
        ...
        <file name="src/yolo_acc.cpp" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
