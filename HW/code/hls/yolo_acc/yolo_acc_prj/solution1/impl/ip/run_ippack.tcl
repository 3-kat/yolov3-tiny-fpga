...
set Library     "hls"
set IPName      "yolo_acc_top"
set Version     "1.0"
set DisplayName "Yolo_acc_top"
set Revision    "2114451978"
...
set sdx_kernel_name "yolo_acc_top"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "/home/kal-thir/Downloads/Tiny_YOLO_v3_ZYNQ/code/hls/yolo_acc/yolo_acc_prj/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {yolo_acc_top_mul_bkb
...
## Variables
set Top "yolo_acc_top"
set TopNoPrefix "yolo_acc_top"
...
set Interfaces {
    s_axi_CTRL_BUS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 input_h_V W 0x0 "Data signal of input_h_V" {{0 9 input_h_V W 0 "Bit 8 to 0 Data signal of input_h_V"} {9 23 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 input_w_V W 0x0 "Data signal of input_w_V" {{0 9 input_w_V W 0 "Bit 8 to 0 Data signal of input_w_V"} {9 23 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 fold_input_ch_V W 0x0 "Data signal of fold_input_ch_V" {{0 4 fold_input_ch_V W 0 "Bit 3 to 0 Data signal of fold_input_ch_V"} {4 28 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 leaky_V W 0x0 "Data signal of leaky_V" {{0 1 leaky_V W 0 "Bit 0 to 0 Data signal of leaky_V"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 bias_en_V W 0x0 "Data signal of bias_en_V" {{0 1 bias_en_V W 0 "Bit 0 to 0 Data signal of bias_en_V"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL_BUS inStream_a inStream_b outStream"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 1384465 II x}
