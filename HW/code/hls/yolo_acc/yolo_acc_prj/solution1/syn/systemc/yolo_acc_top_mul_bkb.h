...
// ==============================================================
#ifndef __yolo_acc_top_mul_bkb__HH__
#define __yolo_acc_top_mul_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(yolo_acc_top_mul_bkb) {
    ...
    SC_CTOR(yolo_acc_top_mul_bkb):  ACMP_smul_us_U ("ACMP_smul_us_U") {
