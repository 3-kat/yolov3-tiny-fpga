...
// ==============================================================
#ifndef __yolo_acc_top_mul_dEe__HH__
#define __yolo_acc_top_mul_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(yolo_acc_top_mul_dEe) {
    ...
    SC_CTOR(yolo_acc_top_mul_dEe):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
