...
set out_width 22
set exp i0*i1
set arg_lists {i0 {13 0 +} i1 {9 0 +} p {22 0 +} acc {0} }
set TrueReset 0
...
set ID 9
set hasByteEnable 0
set MemName yolo_acc_top_kerncud
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 10 \
			corename yolo_acc_top_CTRL_BUS_axilite \
			name yolo_acc_top_CTRL_BUS_s_axi \
			ports {$port_CTRL_BUS} \
			op interface \
			is_flushable 0 \ 
		} "
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler yolo_acc_top_CTRL_BUS_s_axi
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 11 \
    name inStream_a_V_data \
    reset_level 0 \
    sync_rst true \
    corename {inStream_a} \
    metadata {  } \
    op interface \
    ports { inStream_a_TDATA { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'inStream_a_V_data'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { inStream_a_TVALID { I 1 bit } inStream_a_TREADY { O 1 bit } inStream_a_TDEST { I 6 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 18 \
    name inStream_b_V_data \
    reset_level 0 \
    sync_rst true \
    corename {inStream_b} \
    metadata {  } \
    op interface \
    ports { inStream_b_TDATA { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'inStream_b_V_data'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { inStream_b_TVALID { I 1 bit } inStream_b_TREADY { O 1 bit } inStream_b_TDEST { I 6 vector } } \
} "
} else {
