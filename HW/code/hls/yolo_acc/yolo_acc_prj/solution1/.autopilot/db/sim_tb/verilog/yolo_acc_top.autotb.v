...
`define AESL_DEPTH_inStream_a_V_data 1
...
`define AESL_DEPTH_inStream_b_V_data 1
...
`define AESL_DEPTH_bias_en_V 1
`define AUTOTB_TVIN_inStream_a_V_data  "./c.yolo_acc_top.autotvin_inStream_a_V_data.dat"
`define AUTOTB_TVIN_inStream_a_V_keep_V  "./c.yolo_acc_top.autotvin_inStream_a_V_keep_V.dat"
`define AUTOTB_TVIN_inStream_a_V_strb_V  "./c.yolo_acc_top.autotvin_inStream_a_V_strb_V.dat"
`define AUTOTB_TVIN_inStream_a_V_user_V  "./c.yolo_acc_top.autotvin_inStream_a_V_user_V.dat"
`define AUTOTB_TVIN_inStream_a_V_last_V  "./c.yolo_acc_top.autotvin_inStream_a_V_last_V.dat"
`define AUTOTB_TVIN_inStream_a_V_id_V  "./c.yolo_acc_top.autotvin_inStream_a_V_id_V.dat"
`define AUTOTB_TVIN_inStream_a_V_dest_V  "./c.yolo_acc_top.autotvin_inStream_a_V_dest_V.dat"
`define AUTOTB_TVIN_inStream_b_V_data  "./c.yolo_acc_top.autotvin_inStream_b_V_data.dat"
`define AUTOTB_TVIN_inStream_b_V_keep_V  "./c.yolo_acc_top.autotvin_inStream_b_V_keep_V.dat"
`define AUTOTB_TVIN_inStream_b_V_strb_V  "./c.yolo_acc_top.autotvin_inStream_b_V_strb_V.dat"
`define AUTOTB_TVIN_inStream_b_V_user_V  "./c.yolo_acc_top.autotvin_inStream_b_V_user_V.dat"
`define AUTOTB_TVIN_inStream_b_V_last_V  "./c.yolo_acc_top.autotvin_inStream_b_V_last_V.dat"
`define AUTOTB_TVIN_inStream_b_V_id_V  "./c.yolo_acc_top.autotvin_inStream_b_V_id_V.dat"
`define AUTOTB_TVIN_inStream_b_V_dest_V  "./c.yolo_acc_top.autotvin_inStream_b_V_dest_V.dat"
`define AUTOTB_TVIN_outStream_V_data  "./c.yolo_acc_top.autotvin_outStream_V_data.dat"
`define AUTOTB_TVIN_outStream_V_keep_V  "./c.yolo_acc_top.autotvin_outStream_V_keep_V.dat"
`define AUTOTB_TVIN_outStream_V_strb_V  "./c.yolo_acc_top.autotvin_outStream_V_strb_V.dat"
`define AUTOTB_TVIN_outStream_V_user_V  "./c.yolo_acc_top.autotvin_outStream_V_user_V.dat"
`define AUTOTB_TVIN_outStream_V_last_V  "./c.yolo_acc_top.autotvin_outStream_V_last_V.dat"
`define AUTOTB_TVIN_outStream_V_id_V  "./c.yolo_acc_top.autotvin_outStream_V_id_V.dat"
`define AUTOTB_TVIN_outStream_V_dest_V  "./c.yolo_acc_top.autotvin_outStream_V_dest_V.dat"
`define AUTOTB_TVIN_input_h_V  "./c.yolo_acc_top.autotvin_input_h_V.dat"
`define AUTOTB_TVIN_input_w_V  "./c.yolo_acc_top.autotvin_input_w_V.dat"
`define AUTOTB_TVIN_fold_input_ch_V  "./c.yolo_acc_top.autotvin_fold_input_ch_V.dat"
`define AUTOTB_TVIN_leaky_V  "./c.yolo_acc_top.autotvin_leaky_V.dat"
`define AUTOTB_TVIN_bias_en_V  "./c.yolo_acc_top.autotvin_bias_en_V.dat"
`define AUTOTB_TVIN_inStream_a_V_data_out_wrapc  "./rtl.yolo_acc_top.autotvin_inStream_a_V_data.dat"
`define AUTOTB_TVIN_inStream_a_V_keep_V_out_wrapc  "./rtl.yolo_acc_top.autotvin_inStream_a_V_keep_V.dat"
`define AUTOTB_TVIN_inStream_a_V_strb_V_out_wrapc  "./rtl.yolo_acc_top.autotvin_inStream_a_V_strb_V.dat"
`define AUTOTB_TVIN_inStream_a_V_user_V_out_wrapc  "./rtl.yolo_acc_top.autotvin_inStream_a_V_user_V.dat"
`define AUTOTB_TVIN_inStream_a_V_last_V_out_wrapc  "./rtl.yolo_acc_top.autotvin_inStream_a_V_last_V.dat"
`define AUTOTB_TVIN_inStream_a_V_id_V_out_wrapc  "./rtl.yolo_acc_top.autotvin_inStream_a_V_id_V.dat"
`define AUTOTB_TVIN_inStream_a_V_dest_V_out_wrapc  "./rtl.yolo_acc_top.autotvin_inStream_a_V_dest_V.dat"
`define AUTOTB_TVIN_inStream_b_V_data_out_wrapc  "./rtl.yolo_acc_top.autotvin_inStream_b_V_data.dat"
`define AUTOTB_TVIN_inStream_b_V_keep_V_out_wrapc  "./rtl.yolo_acc_top.autotvin_inStream_b_V_keep_V.dat"
`define AUTOTB_TVIN_inStream_b_V_strb_V_out_wrapc  "./rtl.yolo_acc_top.autotvin_inStream_b_V_strb_V.dat"
`define AUTOTB_TVIN_inStream_b_V_user_V_out_wrapc  "./rtl.yolo_acc_top.autotvin_inStream_b_V_user_V.dat"
`define AUTOTB_TVIN_inStream_b_V_last_V_out_wrapc  "./rtl.yolo_acc_top.autotvin_inStream_b_V_last_V.dat"
`define AUTOTB_TVIN_inStream_b_V_id_V_out_wrapc  "./rtl.yolo_acc_top.autotvin_inStream_b_V_id_V.dat"
`define AUTOTB_TVIN_inStream_b_V_dest_V_out_wrapc  "./rtl.yolo_acc_top.autotvin_inStream_b_V_dest_V.dat"
`define AUTOTB_TVIN_outStream_V_data_out_wrapc  "./rtl.yolo_acc_top.autotvin_outStream_V_data.dat"
`define AUTOTB_TVIN_outStream_V_keep_V_out_wrapc  "./rtl.yolo_acc_top.autotvin_outStream_V_keep_V.dat"
`define AUTOTB_TVIN_outStream_V_strb_V_out_wrapc  "./rtl.yolo_acc_top.autotvin_outStream_V_strb_V.dat"
`define AUTOTB_TVIN_outStream_V_user_V_out_wrapc  "./rtl.yolo_acc_top.autotvin_outStream_V_user_V.dat"
`define AUTOTB_TVIN_outStream_V_last_V_out_wrapc  "./rtl.yolo_acc_top.autotvin_outStream_V_last_V.dat"
`define AUTOTB_TVIN_outStream_V_id_V_out_wrapc  "./rtl.yolo_acc_top.autotvin_outStream_V_id_V.dat"
`define AUTOTB_TVIN_outStream_V_dest_V_out_wrapc  "./rtl.yolo_acc_top.autotvin_outStream_V_dest_V.dat"
`define AUTOTB_TVIN_input_h_V_out_wrapc  "./rtl.yolo_acc_top.autotvin_input_h_V.dat"
`define AUTOTB_TVIN_input_w_V_out_wrapc  "./rtl.yolo_acc_top.autotvin_input_w_V.dat"
`define AUTOTB_TVIN_fold_input_ch_V_out_wrapc  "./rtl.yolo_acc_top.autotvin_fold_input_ch_V.dat"
`define AUTOTB_TVIN_leaky_V_out_wrapc  "./rtl.yolo_acc_top.autotvin_leaky_V.dat"
`define AUTOTB_TVIN_bias_en_V_out_wrapc  "./rtl.yolo_acc_top.autotvin_bias_en_V.dat"
`define AUTOTB_TVOUT_outStream_V_data  "./c.yolo_acc_top.autotvout_outStream_V_data.dat"
`define AUTOTB_TVOUT_outStream_V_keep_V  "./c.yolo_acc_top.autotvout_outStream_V_keep_V.dat"
`define AUTOTB_TVOUT_outStream_V_strb_V  "./c.yolo_acc_top.autotvout_outStream_V_strb_V.dat"
`define AUTOTB_TVOUT_outStream_V_user_V  "./c.yolo_acc_top.autotvout_outStream_V_user_V.dat"
`define AUTOTB_TVOUT_outStream_V_last_V  "./c.yolo_acc_top.autotvout_outStream_V_last_V.dat"
`define AUTOTB_TVOUT_outStream_V_id_V  "./c.yolo_acc_top.autotvout_outStream_V_id_V.dat"
`define AUTOTB_TVOUT_outStream_V_dest_V  "./c.yolo_acc_top.autotvout_outStream_V_dest_V.dat"
`define AUTOTB_TVOUT_outStream_V_data_out_wrapc  "./impl_rtl.yolo_acc_top.autotvout_outStream_V_data.dat"
`define AUTOTB_TVOUT_outStream_V_keep_V_out_wrapc  "./impl_rtl.yolo_acc_top.autotvout_outStream_V_keep_V.dat"
`define AUTOTB_TVOUT_outStream_V_strb_V_out_wrapc  "./impl_rtl.yolo_acc_top.autotvout_outStream_V_strb_V.dat"
`define AUTOTB_TVOUT_outStream_V_user_V_out_wrapc  "./impl_rtl.yolo_acc_top.autotvout_outStream_V_user_V.dat"
`define AUTOTB_TVOUT_outStream_V_last_V_out_wrapc  "./impl_rtl.yolo_acc_top.autotvout_outStream_V_last_V.dat"
`define AUTOTB_TVOUT_outStream_V_id_V_out_wrapc  "./impl_rtl.yolo_acc_top.autotvout_outStream_V_id_V.dat"
`define AUTOTB_TVOUT_outStream_V_dest_V_out_wrapc  "./impl_rtl.yolo_acc_top.autotvout_outStream_V_dest_V.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 1384465;
parameter LENGTH_inStream_a_V_data = 692224;
...
parameter LENGTH_inStream_b_V_data = 692228;
...
reg [31:0] ap_c_n_tvin_trans_num_inStream_a_V_data;
...
reg [31:0] ap_c_n_tvin_trans_num_inStream_b_V_data;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.yolo_acc_top.autotvout_outStream_V_data.dat", "r");
    fp2 = $fopen("./impl_rtl.yolo_acc_top.autotvout_outStream_V_data.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.yolo_acc_top.autotvout_outStream_V_data.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.yolo_acc_top.autotvout_outStream_V_data.dat\"!");
    else begin
        $display("Comparing rtl.yolo_acc_top.autotvout_outStream_V_data.dat with impl_rtl.yolo_acc_top.autotvout_outStream_V_data.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.yolo_acc_top.autotvout_outStream_V_keep_V.dat", "r");
    fp2 = $fopen("./impl_rtl.yolo_acc_top.autotvout_outStream_V_keep_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.yolo_acc_top.autotvout_outStream_V_keep_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.yolo_acc_top.autotvout_outStream_V_keep_V.dat\"!");
    else begin
        $display("Comparing rtl.yolo_acc_top.autotvout_outStream_V_keep_V.dat with impl_rtl.yolo_acc_top.autotvout_outStream_V_keep_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.yolo_acc_top.autotvout_outStream_V_strb_V.dat", "r");
    fp2 = $fopen("./impl_rtl.yolo_acc_top.autotvout_outStream_V_strb_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.yolo_acc_top.autotvout_outStream_V_strb_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.yolo_acc_top.autotvout_outStream_V_strb_V.dat\"!");
    else begin
        $display("Comparing rtl.yolo_acc_top.autotvout_outStream_V_strb_V.dat with impl_rtl.yolo_acc_top.autotvout_outStream_V_strb_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.yolo_acc_top.autotvout_outStream_V_user_V.dat", "r");
    fp2 = $fopen("./impl_rtl.yolo_acc_top.autotvout_outStream_V_user_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.yolo_acc_top.autotvout_outStream_V_user_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.yolo_acc_top.autotvout_outStream_V_user_V.dat\"!");
    else begin
        $display("Comparing rtl.yolo_acc_top.autotvout_outStream_V_user_V.dat with impl_rtl.yolo_acc_top.autotvout_outStream_V_user_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.yolo_acc_top.autotvout_outStream_V_last_V.dat", "r");
    fp2 = $fopen("./impl_rtl.yolo_acc_top.autotvout_outStream_V_last_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.yolo_acc_top.autotvout_outStream_V_last_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.yolo_acc_top.autotvout_outStream_V_last_V.dat\"!");
    else begin
        $display("Comparing rtl.yolo_acc_top.autotvout_outStream_V_last_V.dat with impl_rtl.yolo_acc_top.autotvout_outStream_V_last_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.yolo_acc_top.autotvout_outStream_V_id_V.dat", "r");
    fp2 = $fopen("./impl_rtl.yolo_acc_top.autotvout_outStream_V_id_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.yolo_acc_top.autotvout_outStream_V_id_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.yolo_acc_top.autotvout_outStream_V_id_V.dat\"!");
    else begin
        $display("Comparing rtl.yolo_acc_top.autotvout_outStream_V_id_V.dat with impl_rtl.yolo_acc_top.autotvout_outStream_V_id_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.yolo_acc_top.autotvout_outStream_V_dest_V.dat", "r");
    fp2 = $fopen("./impl_rtl.yolo_acc_top.autotvout_outStream_V_dest_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.yolo_acc_top.autotvout_outStream_V_dest_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.yolo_acc_top.autotvout_outStream_V_dest_V.dat\"!");
    else begin
        $display("Comparing rtl.yolo_acc_top.autotvout_outStream_V_dest_V.dat with impl_rtl.yolo_acc_top.autotvout_outStream_V_dest_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
reg end_inStream_a_V_data;
reg [31:0] size_inStream_a_V_data;
reg [31:0] size_inStream_a_V_data_backup;
...
reg end_inStream_b_V_data;
reg [31:0] size_inStream_b_V_data;
reg [31:0] size_inStream_b_V_data_backup;
...
reg end_bias_en_V;
reg [31:0] size_bias_en_V;
reg [31:0] size_bias_en_V_backup;
...
begin
    ...
    initial begin : proc_gen_axis_internal_ready_inStream_a
        ...
        forever begin
            @ (ap_c_n_tvin_trans_num_inStream_a_V_data or inStream_a_transaction);
            if (ap_c_n_tvin_trans_num_inStream_a_V_data > inStream_a_transaction) begin
    ...
    initial begin : proc_gen_axis_internal_ready_inStream_b
        ...
        @ (posedge ready_initial);
        forever begin
            @ (ap_c_n_tvin_trans_num_inStream_b_V_data or inStream_b_transaction);
            if (ap_c_n_tvin_trans_num_inStream_b_V_data > inStream_b_transaction) begin
    ...
    `define STREAM_SIZE_IN_inStream_a_V_data "./stream_size_in_inStream_a_V_data.dat"
    
    initial begin : gen_ap_c_n_tvin_trans_num_inStream_a_V_data
        integer fp_inStream_a_V_data;
        reg [127:0] token_inStream_a_V_data;
        integer ret;
        
        ap_c_n_tvin_trans_num_inStream_a_V_data = 0;
        end_inStream_a_V_data = 0;
        wait (AESL_reset === 1);
        
        fp_inStream_a_V_data = $fopen(`STREAM_SIZE_IN_inStream_a_V_data, "r");
        if(fp_inStream_a_V_data == 0) begin
            $display("Failed to open file \"%s\"!", `STREAM_SIZE_IN_inStream_a_V_data);
            $finish;
        end
        read_token(fp_inStream_a_V_data, token_inStream_a_V_data); // should be [[[runtime]]]
        if (token_inStream_a_V_data != "[[[runtime]]]") begin
            $display("ERROR: token_inStream_a_V_data != \"[[[runtime]]]\"");
            $finish;
        end
        size_inStream_a_V_data = 0;
        size_inStream_a_V_data_backup = 0;
        while (size_inStream_a_V_data == 0 && end_inStream_a_V_data == 0) begin
            ap_c_n_tvin_trans_num_inStream_a_V_data = ap_c_n_tvin_trans_num_inStream_a_V_data + 1;
            read_token(fp_inStream_a_V_data, token_inStream_a_V_data); // should be [[transaction]] or [[[/runtime]]]
            if (token_inStream_a_V_data == "[[transaction]]") begin
                read_token(fp_inStream_a_V_data, token_inStream_a_V_data); // should be transaction number
                read_token(fp_inStream_a_V_data, token_inStream_a_V_data); // should be size for hls::stream
                ret = $sscanf(token_inStream_a_V_data, "%d", size_inStream_a_V_data);
                if (size_inStream_a_V_data > 0) begin
                    size_inStream_a_V_data_backup = size_inStream_a_V_data;
                end
                read_token(fp_inStream_a_V_data, token_inStream_a_V_data); // should be [[/transaction]]
            end else if (token_inStream_a_V_data == "[[[/runtime]]]") begin
                $fclose(fp_inStream_a_V_data);
                end_inStream_a_V_data = 1;
            end else begin
                $display("ERROR: unknown token_inStream_a_V_data");
                $finish;
            end
        end
        forever begin
            @ (posedge AESL_clock);
            if (end_inStream_a_V_data == 0) begin
                if ((inStream_a_TREADY & inStream_a_TVALID) == 1) begin
                    if (size_inStream_a_V_data > 0) begin
                        size_inStream_a_V_data = size_inStream_a_V_data - 1;
                        while (size_inStream_a_V_data == 0 && end_inStream_a_V_data == 0) begin
                            ap_c_n_tvin_trans_num_inStream_a_V_data = ap_c_n_tvin_trans_num_inStream_a_V_data + 1;
                            read_token(fp_inStream_a_V_data, token_inStream_a_V_data); // should be [[transaction]] or [[[/runtime]]]
                            if (token_inStream_a_V_data == "[[transaction]]") begin
                                ...
                                size_inStream_a_V_data = size_inStream_a_V_data_backup;
                                $fclose(fp_inStream_a_V_data);
                                end_inStream_a_V_data = 1;
                            end else begin
                                $display("ERROR: unknown token_inStream_a_V_data");
    ...
    `define STREAM_SIZE_IN_inStream_b_V_data "./stream_size_in_inStream_b_V_data.dat"
    
    initial begin : gen_ap_c_n_tvin_trans_num_inStream_b_V_data
        integer fp_inStream_b_V_data;
        reg [127:0] token_inStream_b_V_data;
        integer ret;
        
        ap_c_n_tvin_trans_num_inStream_b_V_data = 0;
        end_inStream_b_V_data = 0;
        wait (AESL_reset === 1);
        
        fp_inStream_b_V_data = $fopen(`STREAM_SIZE_IN_inStream_b_V_data, "r");
        if(fp_inStream_b_V_data == 0) begin
            $display("Failed to open file \"%s\"!", `STREAM_SIZE_IN_inStream_b_V_data);
            $finish;
        end
        read_token(fp_inStream_b_V_data, token_inStream_b_V_data); // should be [[[runtime]]]
        if (token_inStream_b_V_data != "[[[runtime]]]") begin
            $display("ERROR: token_inStream_b_V_data != \"[[[runtime]]]\"");
            $finish;
        end
        size_inStream_b_V_data = 0;
        size_inStream_b_V_data_backup = 0;
        while (size_inStream_b_V_data == 0 && end_inStream_b_V_data == 0) begin
            ap_c_n_tvin_trans_num_inStream_b_V_data = ap_c_n_tvin_trans_num_inStream_b_V_data + 1;
            read_token(fp_inStream_b_V_data, token_inStream_b_V_data); // should be [[transaction]] or [[[/runtime]]]
            if (token_inStream_b_V_data == "[[transaction]]") begin
                read_token(fp_inStream_b_V_data, token_inStream_b_V_data); // should be transaction number
                read_token(fp_inStream_b_V_data, token_inStream_b_V_data); // should be size for hls::stream
                ret = $sscanf(token_inStream_b_V_data, "%d", size_inStream_b_V_data);
                if (size_inStream_b_V_data > 0) begin
                    size_inStream_b_V_data_backup = size_inStream_b_V_data;
                end
                read_token(fp_inStream_b_V_data, token_inStream_b_V_data); // should be [[/transaction]]
            end else if (token_inStream_b_V_data == "[[[/runtime]]]") begin
                $fclose(fp_inStream_b_V_data);
                end_inStream_b_V_data = 1;
            end else begin
                $display("ERROR: unknown token_inStream_b_V_data");
                $finish;
            end
        end
        forever begin
            @ (posedge AESL_clock);
            if (end_inStream_b_V_data == 0) begin
                if ((inStream_b_TREADY & inStream_b_TVALID) == 1) begin
                    if (size_inStream_b_V_data > 0) begin
                        size_inStream_b_V_data = size_inStream_b_V_data - 1;
                        while (size_inStream_b_V_data == 0 && end_inStream_b_V_data == 0) begin
                            ap_c_n_tvin_trans_num_inStream_b_V_data = ap_c_n_tvin_trans_num_inStream_b_V_data + 1;
                            read_token(fp_inStream_b_V_data, token_inStream_b_V_data); // should be [[transaction]] or [[[/runtime]]]
                            if (token_inStream_b_V_data == "[[transaction]]") begin
                                ...
                                size_inStream_b_V_data = size_inStream_b_V_data_backup;
                                $fclose(fp_inStream_b_V_data);
                                end_inStream_b_V_data = 1;
                            end else begin
                                $display("ERROR: unknown token_inStream_b_V_data");
