...
`define TV_IN_inStream_a_TDATA "../tv/cdatafile/c.yolo_acc_top.autotvin_inStream_a_V_data.dat"
`define INGRESS_STATUS_inStream_a_TDATA "../tv/stream_size/stream_ingress_status_inStream_a_V_data.dat"
`define TV_IN_inStream_a_TKEEP "../tv/cdatafile/c.yolo_acc_top.autotvin_inStream_a_V_keep_V.dat"
`define INGRESS_STATUS_inStream_a_TKEEP "../tv/stream_size/stream_ingress_status_inStream_a_V_keep_V.dat"
`define TV_IN_inStream_a_TSTRB "../tv/cdatafile/c.yolo_acc_top.autotvin_inStream_a_V_strb_V.dat"
`define INGRESS_STATUS_inStream_a_TSTRB "../tv/stream_size/stream_ingress_status_inStream_a_V_strb_V.dat"
`define TV_IN_inStream_a_TUSER "../tv/cdatafile/c.yolo_acc_top.autotvin_inStream_a_V_user_V.dat"
`define INGRESS_STATUS_inStream_a_TUSER "../tv/stream_size/stream_ingress_status_inStream_a_V_user_V.dat"
`define TV_IN_inStream_a_TLAST "../tv/cdatafile/c.yolo_acc_top.autotvin_inStream_a_V_last_V.dat"
`define INGRESS_STATUS_inStream_a_TLAST "../tv/stream_size/stream_ingress_status_inStream_a_V_last_V.dat"
`define TV_IN_inStream_a_TID "../tv/cdatafile/c.yolo_acc_top.autotvin_inStream_a_V_id_V.dat"
`define INGRESS_STATUS_inStream_a_TID "../tv/stream_size/stream_ingress_status_inStream_a_V_id_V.dat"
`define TV_IN_inStream_a_TDEST "../tv/cdatafile/c.yolo_acc_top.autotvin_inStream_a_V_dest_V.dat"
`define INGRESS_STATUS_inStream_a_TDEST "../tv/stream_size/stream_ingress_status_inStream_a_V_dest_V.dat"
...
module AESL_axi_s_inStream_a (
    ...
    fifo #(692224, 64) fifo_inStream_a_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(692224, 8) fifo_inStream_a_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(692224, 8) fifo_inStream_a_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(692224, 2) fifo_inStream_a_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(692224, 1) fifo_inStream_a_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(692224, 5) fifo_inStream_a_TID (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(692224, 6) fifo_inStream_a_TDEST (
        .reset(1'b0),
        .write_clock(clk),
