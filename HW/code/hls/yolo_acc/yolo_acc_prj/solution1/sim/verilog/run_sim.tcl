...
if {[file isfile yolo_acc_top.autotvin.dat]} {
	file delete -force yolo_acc_top.autotvin.dat
}

if {[file isfile yolo_acc_top.autotvout.dat]} {
	file delete -force yolo_acc_top.autotvout.dat
}
