...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "yolo_acc_top.autotvin.dat"
	set constFileTvOut       "yolo_acc_top.autotvout.dat"
	set constFileHdlTvIn     "yolo_acc_top.autohdltvin.dat"
	set constFileHdlTvOut    "yolo_acc_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
