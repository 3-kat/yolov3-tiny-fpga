<AutoPilot:project xmlns:AutoPilot="com.autoesl.autopilot.project" projectType="C/C++" name="yolo_yolo_prj" top="yolo_yolo_top">
    <includePaths/>
    <libraryFlag/>
    <files>
        ...
        <file name="../../tb/yolo_yolo_tb.cpp" sc="0" tb="1" cflags=" -Wno-unknown-pragmas" csimflags=" -Wno-unknown-pragmas" blackbox="false"/>
        ...
        <file name="src/yolo_yolo.cpp" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
