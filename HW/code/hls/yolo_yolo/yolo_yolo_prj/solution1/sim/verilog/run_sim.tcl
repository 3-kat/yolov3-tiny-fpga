...
if {[file isfile yolo_yolo_top.autotvin.dat]} {
	file delete -force yolo_yolo_top.autotvin.dat
}

if {[file isfile yolo_yolo_top.autotvout.dat]} {
	file delete -force yolo_yolo_top.autotvout.dat
}
