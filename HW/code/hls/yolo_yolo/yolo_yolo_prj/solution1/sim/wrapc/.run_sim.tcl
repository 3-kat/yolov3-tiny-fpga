...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "yolo_yolo_top.autotvin.dat"
	set constFileTvOut       "yolo_yolo_top.autotvout.dat"
	set constFileHdlTvIn     "yolo_yolo_top.autohdltvin.dat"
	set constFileHdlTvOut    "yolo_yolo_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
