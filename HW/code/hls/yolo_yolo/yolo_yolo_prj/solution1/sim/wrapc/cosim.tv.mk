...
$(ObjDir)/yolo_yolo_tb.cpp_pre.cpp.tb.o : yolo_yolo_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling yolo_yolo_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/yolo_yolo.cpp_pre.cpp.tb.o : yolo_yolo.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling yolo_yolo.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
