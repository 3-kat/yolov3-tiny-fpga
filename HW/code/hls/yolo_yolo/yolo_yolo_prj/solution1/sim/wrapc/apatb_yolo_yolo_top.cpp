...
#define AUTOTB_TVIN_inStream_V_data  "../tv/cdatafile/c.yolo_yolo_top.autotvin_inStream_V_data.dat"
...
#define AUTOTB_TVIN_inStream_V_keep_V  "../tv/cdatafile/c.yolo_yolo_top.autotvin_inStream_V_keep_V.dat"
...
#define AUTOTB_TVIN_inStream_V_strb_V  "../tv/cdatafile/c.yolo_yolo_top.autotvin_inStream_V_strb_V.dat"
...
#define AUTOTB_TVIN_inStream_V_user_V  "../tv/cdatafile/c.yolo_yolo_top.autotvin_inStream_V_user_V.dat"
...
#define AUTOTB_TVIN_inStream_V_last_V  "../tv/cdatafile/c.yolo_yolo_top.autotvin_inStream_V_last_V.dat"
...
#define AUTOTB_TVIN_inStream_V_id_V  "../tv/cdatafile/c.yolo_yolo_top.autotvin_inStream_V_id_V.dat"
...
#define AUTOTB_TVIN_inStream_V_dest_V  "../tv/cdatafile/c.yolo_yolo_top.autotvin_inStream_V_dest_V.dat"
...
#define AUTOTB_TVOUT_outStream_V_data  "../tv/cdatafile/c.yolo_yolo_top.autotvout_outStream_V_data.dat"
#define AUTOTB_TVIN_outStream_V_data  "../tv/cdatafile/c.yolo_yolo_top.autotvin_outStream_V_data.dat"
...
#define AUTOTB_TVOUT_outStream_V_keep_V  "../tv/cdatafile/c.yolo_yolo_top.autotvout_outStream_V_keep_V.dat"
#define AUTOTB_TVIN_outStream_V_keep_V  "../tv/cdatafile/c.yolo_yolo_top.autotvin_outStream_V_keep_V.dat"
...
#define AUTOTB_TVOUT_outStream_V_strb_V  "../tv/cdatafile/c.yolo_yolo_top.autotvout_outStream_V_strb_V.dat"
#define AUTOTB_TVIN_outStream_V_strb_V  "../tv/cdatafile/c.yolo_yolo_top.autotvin_outStream_V_strb_V.dat"
...
#define AUTOTB_TVOUT_outStream_V_user_V  "../tv/cdatafile/c.yolo_yolo_top.autotvout_outStream_V_user_V.dat"
#define AUTOTB_TVIN_outStream_V_user_V  "../tv/cdatafile/c.yolo_yolo_top.autotvin_outStream_V_user_V.dat"
...
#define AUTOTB_TVOUT_outStream_V_last_V  "../tv/cdatafile/c.yolo_yolo_top.autotvout_outStream_V_last_V.dat"
#define AUTOTB_TVIN_outStream_V_last_V  "../tv/cdatafile/c.yolo_yolo_top.autotvin_outStream_V_last_V.dat"
...
#define AUTOTB_TVOUT_outStream_V_id_V  "../tv/cdatafile/c.yolo_yolo_top.autotvout_outStream_V_id_V.dat"
#define AUTOTB_TVIN_outStream_V_id_V  "../tv/cdatafile/c.yolo_yolo_top.autotvin_outStream_V_id_V.dat"
...
#define AUTOTB_TVOUT_outStream_V_dest_V  "../tv/cdatafile/c.yolo_yolo_top.autotvout_outStream_V_dest_V.dat"
#define AUTOTB_TVIN_outStream_V_dest_V  "../tv/cdatafile/c.yolo_yolo_top.autotvin_outStream_V_dest_V.dat"
...
// wrapc file define: "activate_en_V"
#define AUTOTB_TVIN_activate_en_V  "../tv/cdatafile/c.yolo_yolo_top.autotvin_activate_en_V.dat"
// wrapc file define: "input_h_V"
#define AUTOTB_TVIN_input_h_V  "../tv/cdatafile/c.yolo_yolo_top.autotvin_input_h_V.dat"
// wrapc file define: "input_w_V"
#define AUTOTB_TVIN_input_w_V  "../tv/cdatafile/c.yolo_yolo_top.autotvin_input_w_V.dat"

#define INTER_TCL  "../tv/cdatafile/ref.tcl"

// tvout file define: "outStream_V_data"
#define AUTOTB_TVOUT_PC_outStream_V_data  "../tv/rtldatafile/rtl.yolo_yolo_top.autotvout_outStream_V_data.dat"
// tvout file define: "outStream_V_keep_V"
#define AUTOTB_TVOUT_PC_outStream_V_keep_V  "../tv/rtldatafile/rtl.yolo_yolo_top.autotvout_outStream_V_keep_V.dat"
// tvout file define: "outStream_V_strb_V"
#define AUTOTB_TVOUT_PC_outStream_V_strb_V  "../tv/rtldatafile/rtl.yolo_yolo_top.autotvout_outStream_V_strb_V.dat"
// tvout file define: "outStream_V_user_V"
#define AUTOTB_TVOUT_PC_outStream_V_user_V  "../tv/rtldatafile/rtl.yolo_yolo_top.autotvout_outStream_V_user_V.dat"
// tvout file define: "outStream_V_last_V"
#define AUTOTB_TVOUT_PC_outStream_V_last_V  "../tv/rtldatafile/rtl.yolo_yolo_top.autotvout_outStream_V_last_V.dat"
// tvout file define: "outStream_V_id_V"
#define AUTOTB_TVOUT_PC_outStream_V_id_V  "../tv/rtldatafile/rtl.yolo_yolo_top.autotvout_outStream_V_id_V.dat"
// tvout file define: "outStream_V_dest_V"
#define AUTOTB_TVOUT_PC_outStream_V_dest_V  "../tv/rtldatafile/rtl.yolo_yolo_top.autotvout_outStream_V_dest_V.dat"
...
class INTER_TCL_FILE {
	public:
		...
		string get_depth_list () {
			...
			total_list << "{activate_en_V " << activate_en_V_depth << "}\n";
...
ap_uint<5> input_w)
{
			...
			if (i > 0)
			{
				// RTL Name: outStream_V_data
				{
					...
					// {
						...
						// {
							sc_lv<16>* outStream_V_data_sub_data_0_V_lv0_0_0_1_lv1_0_0_1 = new sc_lv<16>[aesl_tmp_10 - aesl_tmp_11];
						// }
					// }
					// bitslice(31, 16)
					// {
						...
						// {
							sc_lv<16>* outStream_V_data_sub_data_1_V_lv0_0_0_1_lv1_0_0_1 = new sc_lv<16>[aesl_tmp_10 - aesl_tmp_11];
						// }
					// }
					// bitslice(47, 32)
					// {
						...
						// {
							sc_lv<16>* outStream_V_data_sub_data_2_V_lv0_0_0_1_lv1_0_0_1 = new sc_lv<16>[aesl_tmp_10 - aesl_tmp_11];
						// }
					// }
					// bitslice(63, 48)
					// {
						...
						// {
							sc_lv<16>* outStream_V_data_sub_data_3_V_lv0_0_0_1_lv1_0_0_1 = new sc_lv<16>[aesl_tmp_10 - aesl_tmp_11];
						// }
					// }
						...
						// celement: outStream.V.data.sub_data_0.V(15, 0)
						{
							...
							for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 0; i_1 += 1)
								{
									...
									// output_left_conversion : (aesl_tmp_9[i_0].data.sub_data_0).range()
									// output_type_conversion : (outStream_V_data_sub_data_0_V_lv0_0_0_1_lv1_0_0_1[hls_map_index]).to_string(SC_BIN).c_str()
									if (&(aesl_tmp_9[0].data.sub_data_0) != NULL) // check the null address if the c port is array or others
									{
										(aesl_tmp_9[i_0].data.sub_data_0).range() = (outStream_V_data_sub_data_0_V_lv0_0_0_1_lv1_0_0_1[hls_map_index]).to_string(SC_BIN).c_str();
										hls_map_index++;
									}
								}
							}
						...
						// celement: outStream.V.data.sub_data_1.V(15, 0)
						{
							...
							for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 0; i_1 += 1)
								{
									...
									// output_left_conversion : (aesl_tmp_9[i_0].data.sub_data_1).range()
									// output_type_conversion : (outStream_V_data_sub_data_1_V_lv0_0_0_1_lv1_0_0_1[hls_map_index]).to_string(SC_BIN).c_str()
									if (&(aesl_tmp_9[0].data.sub_data_1) != NULL) // check the null address if the c port is array or others
									{
										(aesl_tmp_9[i_0].data.sub_data_1).range() = (outStream_V_data_sub_data_1_V_lv0_0_0_1_lv1_0_0_1[hls_map_index]).to_string(SC_BIN).c_str();
										hls_map_index++;
									}
								}
							}
						...
						// celement: outStream.V.data.sub_data_2.V(15, 0)
						{
							...
							for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 0; i_1 += 1)
								{
									...
									// output_left_conversion : (aesl_tmp_9[i_0].data.sub_data_2).range()
									// output_type_conversion : (outStream_V_data_sub_data_2_V_lv0_0_0_1_lv1_0_0_1[hls_map_index]).to_string(SC_BIN).c_str()
									if (&(aesl_tmp_9[0].data.sub_data_2) != NULL) // check the null address if the c port is array or others
									{
										(aesl_tmp_9[i_0].data.sub_data_2).range() = (outStream_V_data_sub_data_2_V_lv0_0_0_1_lv1_0_0_1[hls_map_index]).to_string(SC_BIN).c_str();
										hls_map_index++;
									}
								}
							}
						...
						// celement: outStream.V.data.sub_data_3.V(15, 0)
						{
							...
							for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 0; i_1 += 1)
								{
									...
									// output_left_conversion : (aesl_tmp_9[i_0].data.sub_data_3).range()
									// output_type_conversion : (outStream_V_data_sub_data_3_V_lv0_0_0_1_lv1_0_0_1[hls_map_index]).to_string(SC_BIN).c_str()
									if (&(aesl_tmp_9[0].data.sub_data_3) != NULL) // check the null address if the c port is array or others
									{
										(aesl_tmp_9[i_0].data.sub_data_3).range() = (outStream_V_data_sub_data_3_V_lv0_0_0_1_lv1_0_0_1[hls_map_index]).to_string(SC_BIN).c_str();
										hls_map_index++;
									}
								}
							}
			...
			if (i > 0)
			{
				// RTL Name: outStream_V_keep_V
				{
					...
					// {
						...
						// {
							sc_lv<8>* outStream_V_keep_V_lv0_0_0_1_lv1_0_0_1 = new sc_lv<8>[aesl_tmp_10 - aesl_tmp_11];
						// }
					// }
						...
						// celement: outStream.V.keep.V(7, 0)
						{
							...
							for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 0; i_1 += 1)
								{
									...
									if (&(aesl_tmp_9[0].keep) != NULL) // check the null address if the c port is array or others
									{
										aesl_tmp_9[i_0].keep = (outStream_V_keep_V_lv0_0_0_1_lv1_0_0_1[hls_map_index]).to_string(SC_BIN).c_str();
										hls_map_index++;
									}
								}
							}
			...
			if (i > 0)
			{
				// RTL Name: outStream_V_strb_V
				{
					...
					// {
						...
						// {
							sc_lv<8>* outStream_V_strb_V_lv0_0_0_1_lv1_0_0_1 = new sc_lv<8>[aesl_tmp_10 - aesl_tmp_11];
						// }
					// }
						...
						// celement: outStream.V.strb.V(7, 0)
						{
							...
							for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 0; i_1 += 1)
								{
									...
									if (&(aesl_tmp_9[0].strb) != NULL) // check the null address if the c port is array or others
									{
										aesl_tmp_9[i_0].strb = (outStream_V_strb_V_lv0_0_0_1_lv1_0_0_1[hls_map_index]).to_string(SC_BIN).c_str();
										hls_map_index++;
									}
								}
							}
			...
			if (i > 0)
			{
				// RTL Name: outStream_V_user_V
				{
					...
					// {
						...
						// {
							sc_lv<2>* outStream_V_user_V_lv0_0_0_1_lv1_0_0_1 = new sc_lv<2>[aesl_tmp_10 - aesl_tmp_11];
						// }
					// }
						...
						// celement: outStream.V.user.V(1, 0)
						{
							...
							for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 0; i_1 += 1)
								{
									...
									if (&(aesl_tmp_9[0].user) != NULL) // check the null address if the c port is array or others
									{
										aesl_tmp_9[i_0].user = (outStream_V_user_V_lv0_0_0_1_lv1_0_0_1[hls_map_index]).to_string(SC_BIN).c_str();
										hls_map_index++;
									}
								}
							}
			...
			if (i > 0)
			{
				// RTL Name: outStream_V_last_V
				{
					...
					// {
						...
						// {
							sc_lv<1>* outStream_V_last_V_lv0_0_0_1_lv1_0_0_1 = new sc_lv<1>[aesl_tmp_10 - aesl_tmp_11];
						// }
					// }
						...
						// celement: outStream.V.last.V(0, 0)
						{
							...
							for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 0; i_1 += 1)
								{
									...
									if (&(aesl_tmp_9[0].last) != NULL) // check the null address if the c port is array or others
									{
										aesl_tmp_9[i_0].last = (outStream_V_last_V_lv0_0_0_1_lv1_0_0_1[hls_map_index]).to_string(SC_BIN).c_str();
										hls_map_index++;
									}
								}
							}
			...
			if (i > 0)
			{
				// RTL Name: outStream_V_id_V
				{
					...
					// {
						...
						// {
							sc_lv<5>* outStream_V_id_V_lv0_0_0_1_lv1_0_0_1 = new sc_lv<5>[aesl_tmp_10 - aesl_tmp_11];
						// }
					// }
						...
						// celement: outStream.V.id.V(4, 0)
						{
							...
							for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 0; i_1 += 1)
								{
									...
									if (&(aesl_tmp_9[0].id) != NULL) // check the null address if the c port is array or others
									{
										aesl_tmp_9[i_0].id = (outStream_V_id_V_lv0_0_0_1_lv1_0_0_1[hls_map_index]).to_string(SC_BIN).c_str();
										hls_map_index++;
									}
								}
							}
			...
			if (i > 0)
			{
				// RTL Name: outStream_V_dest_V
				{
					...
					// {
						...
						// {
							sc_lv<6>* outStream_V_dest_V_lv0_0_0_1_lv1_0_0_1 = new sc_lv<6>[aesl_tmp_10 - aesl_tmp_11];
						// }
					// }
						...
						// celement: outStream.V.dest.V(5, 0)
						{
							...
							for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 0; i_1 += 1)
								{
									...
									if (&(aesl_tmp_9[0].dest) != NULL) // check the null address if the c port is array or others
									{
										aesl_tmp_9[i_0].dest = (outStream_V_dest_V_lv0_0_0_1_lv1_0_0_1[hls_map_index]).to_string(SC_BIN).c_str();
										hls_map_index++;
									}
								}
							}
	...
	else
	{
		...
		// "activate_en_V"
		char* tvin_activate_en_V = new char[50];
		aesl_fh.touch(AUTOTB_TVIN_activate_en_V);
		...
		std::vector<ap_axi_fp<64, 2, 5, 6 > > aesl_tmp_6;
		int aesl_tmp_7 = 0;
		while (!inStream.empty())
		{
			aesl_tmp_6.push_back(inStream.read());
			aesl_tmp_7++;
		}
		...
		{
			aesl_tmp_9.push_back(outStream.read());
			aesl_tmp_10++;
		}

		// [[transaction]]
		sprintf(tvin_activate_en_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_activate_en_V, tvin_activate_en_V);

		sc_bv<32> activate_en_V_tvin_wrapc_buffer;

		// RTL Name: activate_en_V
		{
			// bitslice(31, 0)
			{
				// celement: activate_en.V(31, 0)
				{
					// carray: (0) => (0) @ (0)
					{
						// sub                   : 
						// ori_name              : activate_en
						// sub_1st_elem          : 
						// ori_name_1st_elem     : activate_en
						// regulate_c_name       : activate_en_V
						// input_type_conversion : (activate_en).to_string(2).c_str()
						if (&(activate_en) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<32> activate_en_V_tmp_mem;
							activate_en_V_tmp_mem = (activate_en).to_string(2).c_str();
							activate_en_V_tvin_wrapc_buffer.range(31, 0) = activate_en_V_tmp_mem.range(31, 0);
						}
					}
				}
			}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_activate_en_V, "%s\n", (activate_en_V_tvin_wrapc_buffer).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_activate_en_V, tvin_activate_en_V);
		}

		tcl_file.set_num(1, &tcl_file.activate_en_V_depth);
		sprintf(tvin_activate_en_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_activate_en_V, tvin_activate_en_V);
		...
		sc_bv<5> input_h_V_tvin_wrapc_buffer;

		// RTL Name: input_h_V
		{
			// bitslice(4, 0)
			{
				// celement: input_h.V(4, 0)
				{
					// carray: (0) => (0) @ (0)
					{
						// sub                   : 
						...
						{
							sc_lv<5> input_h_V_tmp_mem;
							input_h_V_tmp_mem = (input_h).to_string(2).c_str();
							input_h_V_tvin_wrapc_buffer.range(4, 0) = input_h_V_tmp_mem.range(4, 0);
						}
					}
				}
			}
		...
		sc_bv<5> input_w_V_tvin_wrapc_buffer;

		// RTL Name: input_w_V
		{
			// bitslice(4, 0)
			{
				// celement: input_w.V(4, 0)
				{
					// carray: (0) => (0) @ (0)
					{
						// sub                   : 
						...
						{
							sc_lv<5> input_w_V_tmp_mem;
							input_w_V_tmp_mem = (input_w).to_string(2).c_str();
							input_w_V_tvin_wrapc_buffer.range(4, 0) = input_w_V_tmp_mem.range(4, 0);
						}
					}
				}
			}
...
// [call_c_dut] ---------->
		...
		yolo_yolo_top(inStream, outStream, activate_en, input_h, input_w);

		CodeState = DUMP_OUTPUTS;
		// record input size to tv3: "inStream"
		int aesl_tmp_8 = inStream.size();
     ...
     aesl_tmp_9.clear();
		...
		sc_bv<64>* inStream_V_data_tvin_wrapc_buffer = new sc_bv<64>[aesl_tmp_7 - aesl_tmp_8];
			...
			// bitslice(15, 0)
			{
				...
				// celement: inStream.V.data.sub_data_0.V(15, 0)
				{
					...
					for (int i_0 = 0; i_0 <= aesl_tmp_7 - aesl_tmp_8 - 1; i_0 += 1)
					{
						...
						{
							// sub                   : i_0 i_1
							// ori_name              : aesl_tmp_6[i_0].data.sub_data_0
							// sub_1st_elem          : 0 0
							// ori_name_1st_elem     : aesl_tmp_6[0].data.sub_data_0
							// regulate_c_name       : inStream_V_data_sub_data_0_V
							// input_type_conversion : (aesl_tmp_6[i_0].data.sub_data_0).range().to_string(SC_BIN).c_str()
							if (&(aesl_tmp_6[0].data.sub_data_0) != NULL) // check the null address if the c port is array or others
							{
								sc_lv<16> inStream_V_data_sub_data_0_V_tmp_mem;
								inStream_V_data_sub_data_0_V_tmp_mem = (aesl_tmp_6[i_0].data.sub_data_0).range().to_string(SC_BIN).c_str();
			...
			// bitslice(31, 16)
			{
				...
				// celement: inStream.V.data.sub_data_1.V(15, 0)
				{
					...
					for (int i_0 = 0; i_0 <= aesl_tmp_7 - aesl_tmp_8 - 1; i_0 += 1)
					{
						...
						{
							// sub                   : i_0 i_1
							// ori_name              : aesl_tmp_6[i_0].data.sub_data_1
							// sub_1st_elem          : 0 0
							// ori_name_1st_elem     : aesl_tmp_6[0].data.sub_data_1
							// regulate_c_name       : inStream_V_data_sub_data_1_V
							// input_type_conversion : (aesl_tmp_6[i_0].data.sub_data_1).range().to_string(SC_BIN).c_str()
							if (&(aesl_tmp_6[0].data.sub_data_1) != NULL) // check the null address if the c port is array or others
							{
								sc_lv<16> inStream_V_data_sub_data_1_V_tmp_mem;
								inStream_V_data_sub_data_1_V_tmp_mem = (aesl_tmp_6[i_0].data.sub_data_1).range().to_string(SC_BIN).c_str();
			...
			// bitslice(47, 32)
			{
				...
				// celement: inStream.V.data.sub_data_2.V(15, 0)
				{
					...
					for (int i_0 = 0; i_0 <= aesl_tmp_7 - aesl_tmp_8 - 1; i_0 += 1)
					{
						...
						{
							// sub                   : i_0 i_1
							// ori_name              : aesl_tmp_6[i_0].data.sub_data_2
							// sub_1st_elem          : 0 0
							// ori_name_1st_elem     : aesl_tmp_6[0].data.sub_data_2
							// regulate_c_name       : inStream_V_data_sub_data_2_V
							// input_type_conversion : (aesl_tmp_6[i_0].data.sub_data_2).range().to_string(SC_BIN).c_str()
							if (&(aesl_tmp_6[0].data.sub_data_2) != NULL) // check the null address if the c port is array or others
							{
								sc_lv<16> inStream_V_data_sub_data_2_V_tmp_mem;
								inStream_V_data_sub_data_2_V_tmp_mem = (aesl_tmp_6[i_0].data.sub_data_2).range().to_string(SC_BIN).c_str();
			...
			// bitslice(63, 48)
			{
				...
				// celement: inStream.V.data.sub_data_3.V(15, 0)
				{
					...
					for (int i_0 = 0; i_0 <= aesl_tmp_7 - aesl_tmp_8 - 1; i_0 += 1)
					{
						...
						{
							// sub                   : i_0 i_1
							// ori_name              : aesl_tmp_6[i_0].data.sub_data_3
							// sub_1st_elem          : 0 0
							// ori_name_1st_elem     : aesl_tmp_6[0].data.sub_data_3
							// regulate_c_name       : inStream_V_data_sub_data_3_V
							// input_type_conversion : (aesl_tmp_6[i_0].data.sub_data_3).range().to_string(SC_BIN).c_str()
							if (&(aesl_tmp_6[0].data.sub_data_3) != NULL) // check the null address if the c port is array or others
							{
								sc_lv<16> inStream_V_data_sub_data_3_V_tmp_mem;
								inStream_V_data_sub_data_3_V_tmp_mem = (aesl_tmp_6[i_0].data.sub_data_3).range().to_string(SC_BIN).c_str();
     ...
     {
		sc_int<32> stream_ingress_size_inStream_V_data = aesl_tmp_7;
		...
		tcl_file.set_num(aesl_tmp_7 - aesl_tmp_8, &tcl_file.inStream_V_data_depth);
		...
		sc_bv<8>* inStream_V_keep_V_tvin_wrapc_buffer = new sc_bv<8>[aesl_tmp_7 - aesl_tmp_8];
					...
					for (int i_0 = 0; i_0 <= aesl_tmp_7 - aesl_tmp_8 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_6[0].keep) != NULL) // check the null address if the c port is array or others
							{
								...
								inStream_V_keep_V_tmp_mem = (aesl_tmp_6[i_0].keep).to_string(2).c_str();
     ...
     if (aesl_tmp_7 > aesl_tmp_8)
     {
		sc_int<32> stream_ingress_size_inStream_V_keep_V = aesl_tmp_7;
		...
		tcl_file.set_num(aesl_tmp_7 - aesl_tmp_8, &tcl_file.inStream_V_keep_V_depth);
		...
		sc_bv<8>* inStream_V_strb_V_tvin_wrapc_buffer = new sc_bv<8>[aesl_tmp_7 - aesl_tmp_8];
					...
					for (int i_0 = 0; i_0 <= aesl_tmp_7 - aesl_tmp_8 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_6[0].strb) != NULL) // check the null address if the c port is array or others
							{
								...
								inStream_V_strb_V_tmp_mem = (aesl_tmp_6[i_0].strb).to_string(2).c_str();
     ...
     if (aesl_tmp_7 > aesl_tmp_8)
     {
		sc_int<32> stream_ingress_size_inStream_V_strb_V = aesl_tmp_7;
		...
		tcl_file.set_num(aesl_tmp_7 - aesl_tmp_8, &tcl_file.inStream_V_strb_V_depth);
		...
		sc_bv<2>* inStream_V_user_V_tvin_wrapc_buffer = new sc_bv<2>[aesl_tmp_7 - aesl_tmp_8];
					...
					for (int i_0 = 0; i_0 <= aesl_tmp_7 - aesl_tmp_8 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_6[0].user) != NULL) // check the null address if the c port is array or others
							{
								...
								inStream_V_user_V_tmp_mem = (aesl_tmp_6[i_0].user).to_string(2).c_str();
     ...
     if (aesl_tmp_7 > aesl_tmp_8)
     {
		sc_int<32> stream_ingress_size_inStream_V_user_V = aesl_tmp_7;
		...
		tcl_file.set_num(aesl_tmp_7 - aesl_tmp_8, &tcl_file.inStream_V_user_V_depth);
		...
		sc_bv<1>* inStream_V_last_V_tvin_wrapc_buffer = new sc_bv<1>[aesl_tmp_7 - aesl_tmp_8];
					...
					for (int i_0 = 0; i_0 <= aesl_tmp_7 - aesl_tmp_8 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_6[0].last) != NULL) // check the null address if the c port is array or others
							{
								...
								inStream_V_last_V_tmp_mem = (aesl_tmp_6[i_0].last).to_string(2).c_str();
     ...
     if (aesl_tmp_7 > aesl_tmp_8)
     {
		sc_int<32> stream_ingress_size_inStream_V_last_V = aesl_tmp_7;
		...
		tcl_file.set_num(aesl_tmp_7 - aesl_tmp_8, &tcl_file.inStream_V_last_V_depth);
		...
		sc_bv<5>* inStream_V_id_V_tvin_wrapc_buffer = new sc_bv<5>[aesl_tmp_7 - aesl_tmp_8];
					...
					for (int i_0 = 0; i_0 <= aesl_tmp_7 - aesl_tmp_8 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_6[0].id) != NULL) // check the null address if the c port is array or others
							{
								...
								inStream_V_id_V_tmp_mem = (aesl_tmp_6[i_0].id).to_string(2).c_str();
     ...
     if (aesl_tmp_7 > aesl_tmp_8)
     {
		sc_int<32> stream_ingress_size_inStream_V_id_V = aesl_tmp_7;
		...
		tcl_file.set_num(aesl_tmp_7 - aesl_tmp_8, &tcl_file.inStream_V_id_V_depth);
		...
		sc_bv<6>* inStream_V_dest_V_tvin_wrapc_buffer = new sc_bv<6>[aesl_tmp_7 - aesl_tmp_8];
					...
					for (int i_0 = 0; i_0 <= aesl_tmp_7 - aesl_tmp_8 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_6[0].dest) != NULL) // check the null address if the c port is array or others
							{
								...
								inStream_V_dest_V_tmp_mem = (aesl_tmp_6[i_0].dest).to_string(2).c_str();
     ...
     if (aesl_tmp_7 > aesl_tmp_8)
     {
		sc_int<32> stream_ingress_size_inStream_V_dest_V = aesl_tmp_7;
		...
		tcl_file.set_num(aesl_tmp_7 - aesl_tmp_8, &tcl_file.inStream_V_dest_V_depth);
		...
		sc_bv<64>* outStream_V_data_tvout_wrapc_buffer = new sc_bv<64>[aesl_tmp_10 - aesl_tmp_11];
					...
					for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_9[0].data.sub_data_0) != NULL) // check the null address if the c port is array or others
							{
								...
								outStream_V_data_sub_data_0_V_tmp_mem = (aesl_tmp_9[i_0].data.sub_data_0).range().to_string(SC_BIN).c_str();
					...
					for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_9[0].data.sub_data_1) != NULL) // check the null address if the c port is array or others
							{
								...
								outStream_V_data_sub_data_1_V_tmp_mem = (aesl_tmp_9[i_0].data.sub_data_1).range().to_string(SC_BIN).c_str();
					...
					for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_9[0].data.sub_data_2) != NULL) // check the null address if the c port is array or others
							{
								...
								outStream_V_data_sub_data_2_V_tmp_mem = (aesl_tmp_9[i_0].data.sub_data_2).range().to_string(SC_BIN).c_str();
					...
					for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_9[0].data.sub_data_3) != NULL) // check the null address if the c port is array or others
							{
								...
								outStream_V_data_sub_data_3_V_tmp_mem = (aesl_tmp_9[i_0].data.sub_data_3).range().to_string(SC_BIN).c_str();
		...
		tcl_file.set_num(aesl_tmp_10 - aesl_tmp_11, &tcl_file.outStream_V_data_depth);
		...
		sc_bv<8>* outStream_V_keep_V_tvout_wrapc_buffer = new sc_bv<8>[aesl_tmp_10 - aesl_tmp_11];
					...
					for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_9[0].keep) != NULL) // check the null address if the c port is array or others
							{
								...
								outStream_V_keep_V_tmp_mem = (aesl_tmp_9[i_0].keep).to_string(2).c_str();
		...
		tcl_file.set_num(aesl_tmp_10 - aesl_tmp_11, &tcl_file.outStream_V_keep_V_depth);
		...
		sc_bv<8>* outStream_V_strb_V_tvout_wrapc_buffer = new sc_bv<8>[aesl_tmp_10 - aesl_tmp_11];
					...
					for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_9[0].strb) != NULL) // check the null address if the c port is array or others
							{
								...
								outStream_V_strb_V_tmp_mem = (aesl_tmp_9[i_0].strb).to_string(2).c_str();
		...
		tcl_file.set_num(aesl_tmp_10 - aesl_tmp_11, &tcl_file.outStream_V_strb_V_depth);
		...
		sc_bv<2>* outStream_V_user_V_tvout_wrapc_buffer = new sc_bv<2>[aesl_tmp_10 - aesl_tmp_11];
					...
					for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_9[0].user) != NULL) // check the null address if the c port is array or others
							{
								...
								outStream_V_user_V_tmp_mem = (aesl_tmp_9[i_0].user).to_string(2).c_str();
		...
		tcl_file.set_num(aesl_tmp_10 - aesl_tmp_11, &tcl_file.outStream_V_user_V_depth);
		...
		sc_bv<1>* outStream_V_last_V_tvout_wrapc_buffer = new sc_bv<1>[aesl_tmp_10 - aesl_tmp_11];
					...
					for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_9[0].last) != NULL) // check the null address if the c port is array or others
							{
								...
								outStream_V_last_V_tmp_mem = (aesl_tmp_9[i_0].last).to_string(2).c_str();
		...
		tcl_file.set_num(aesl_tmp_10 - aesl_tmp_11, &tcl_file.outStream_V_last_V_depth);
		...
		sc_bv<5>* outStream_V_id_V_tvout_wrapc_buffer = new sc_bv<5>[aesl_tmp_10 - aesl_tmp_11];
					...
					for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_9[0].id) != NULL) // check the null address if the c port is array or others
							{
								...
								outStream_V_id_V_tmp_mem = (aesl_tmp_9[i_0].id).to_string(2).c_str();
		...
		tcl_file.set_num(aesl_tmp_10 - aesl_tmp_11, &tcl_file.outStream_V_id_V_depth);
		...
		sc_bv<6>* outStream_V_dest_V_tvout_wrapc_buffer = new sc_bv<6>[aesl_tmp_10 - aesl_tmp_11];
					...
					for (int i_0 = aesl_tmp_11; i_0 <= aesl_tmp_10 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_9[0].dest) != NULL) // check the null address if the c port is array or others
							{
								...
								outStream_V_dest_V_tmp_mem = (aesl_tmp_9[i_0].dest).to_string(2).c_str();
		...
		tcl_file.set_num(aesl_tmp_10 - aesl_tmp_11, &tcl_file.outStream_V_dest_V_depth);
		...
		// release memory allocation: "activate_en_V"
		delete [] tvin_activate_en_V;
