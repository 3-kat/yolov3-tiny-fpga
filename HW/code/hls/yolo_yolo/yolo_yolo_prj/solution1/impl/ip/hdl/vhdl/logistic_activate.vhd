...
architecture behav of logistic_activate is 
    ...
    component yolo_yolo_top_sdieOg IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    ...
    yolo_yolo_top_sdieOg_U5 : component yolo_yolo_top_sdieOg
    generic map (
        ID => 1,
        NUM_STAGE => 22,
        din0_WIDTH => 18,
    ...
    ap_phi_mux_agg_result_V_2_phi_fu_50_p6_assign_proc : process(icmp_ln1498_reg_220_pp0_iter27_reg, ap_phi_reg_pp0_iter28_agg_result_V_2_reg_46, select_ln388_fu_206_p3, or_ln340_1_fu_191_p2, select_ln340_fu_197_p3)
    begin
        if ((icmp_ln1498_reg_220_pp0_iter27_reg = ap_const_lv1_0)) then
