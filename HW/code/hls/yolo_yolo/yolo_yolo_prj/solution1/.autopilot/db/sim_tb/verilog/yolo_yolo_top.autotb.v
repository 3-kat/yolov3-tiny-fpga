...
`define AUTOTB_DUT      yolo_yolo_top
`define AUTOTB_DUT_INST AESL_inst_yolo_yolo_top
`define AUTOTB_TOP      apatb_yolo_yolo_top_top
`define AUTOTB_LAT_RESULT_FILE "yolo_yolo_top.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "yolo_yolo_top.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_yolo_yolo_top_top
...
`define AESL_DEPTH_activate_en_V 1
`define AESL_DEPTH_input_h_V 1
`define AESL_DEPTH_input_w_V 1
`define AUTOTB_TVIN_inStream_V_data  "./c.yolo_yolo_top.autotvin_inStream_V_data.dat"
`define AUTOTB_TVIN_inStream_V_keep_V  "./c.yolo_yolo_top.autotvin_inStream_V_keep_V.dat"
`define AUTOTB_TVIN_inStream_V_strb_V  "./c.yolo_yolo_top.autotvin_inStream_V_strb_V.dat"
`define AUTOTB_TVIN_inStream_V_user_V  "./c.yolo_yolo_top.autotvin_inStream_V_user_V.dat"
`define AUTOTB_TVIN_inStream_V_last_V  "./c.yolo_yolo_top.autotvin_inStream_V_last_V.dat"
`define AUTOTB_TVIN_inStream_V_id_V  "./c.yolo_yolo_top.autotvin_inStream_V_id_V.dat"
`define AUTOTB_TVIN_inStream_V_dest_V  "./c.yolo_yolo_top.autotvin_inStream_V_dest_V.dat"
`define AUTOTB_TVIN_outStream_V_data  "./c.yolo_yolo_top.autotvin_outStream_V_data.dat"
`define AUTOTB_TVIN_outStream_V_keep_V  "./c.yolo_yolo_top.autotvin_outStream_V_keep_V.dat"
`define AUTOTB_TVIN_outStream_V_strb_V  "./c.yolo_yolo_top.autotvin_outStream_V_strb_V.dat"
`define AUTOTB_TVIN_outStream_V_user_V  "./c.yolo_yolo_top.autotvin_outStream_V_user_V.dat"
`define AUTOTB_TVIN_outStream_V_last_V  "./c.yolo_yolo_top.autotvin_outStream_V_last_V.dat"
`define AUTOTB_TVIN_outStream_V_id_V  "./c.yolo_yolo_top.autotvin_outStream_V_id_V.dat"
`define AUTOTB_TVIN_outStream_V_dest_V  "./c.yolo_yolo_top.autotvin_outStream_V_dest_V.dat"
`define AUTOTB_TVIN_activate_en_V  "./c.yolo_yolo_top.autotvin_activate_en_V.dat"
`define AUTOTB_TVIN_input_h_V  "./c.yolo_yolo_top.autotvin_input_h_V.dat"
`define AUTOTB_TVIN_input_w_V  "./c.yolo_yolo_top.autotvin_input_w_V.dat"
`define AUTOTB_TVIN_inStream_V_data_out_wrapc  "./rtl.yolo_yolo_top.autotvin_inStream_V_data.dat"
`define AUTOTB_TVIN_inStream_V_keep_V_out_wrapc  "./rtl.yolo_yolo_top.autotvin_inStream_V_keep_V.dat"
`define AUTOTB_TVIN_inStream_V_strb_V_out_wrapc  "./rtl.yolo_yolo_top.autotvin_inStream_V_strb_V.dat"
`define AUTOTB_TVIN_inStream_V_user_V_out_wrapc  "./rtl.yolo_yolo_top.autotvin_inStream_V_user_V.dat"
`define AUTOTB_TVIN_inStream_V_last_V_out_wrapc  "./rtl.yolo_yolo_top.autotvin_inStream_V_last_V.dat"
`define AUTOTB_TVIN_inStream_V_id_V_out_wrapc  "./rtl.yolo_yolo_top.autotvin_inStream_V_id_V.dat"
`define AUTOTB_TVIN_inStream_V_dest_V_out_wrapc  "./rtl.yolo_yolo_top.autotvin_inStream_V_dest_V.dat"
`define AUTOTB_TVIN_outStream_V_data_out_wrapc  "./rtl.yolo_yolo_top.autotvin_outStream_V_data.dat"
`define AUTOTB_TVIN_outStream_V_keep_V_out_wrapc  "./rtl.yolo_yolo_top.autotvin_outStream_V_keep_V.dat"
`define AUTOTB_TVIN_outStream_V_strb_V_out_wrapc  "./rtl.yolo_yolo_top.autotvin_outStream_V_strb_V.dat"
`define AUTOTB_TVIN_outStream_V_user_V_out_wrapc  "./rtl.yolo_yolo_top.autotvin_outStream_V_user_V.dat"
`define AUTOTB_TVIN_outStream_V_last_V_out_wrapc  "./rtl.yolo_yolo_top.autotvin_outStream_V_last_V.dat"
`define AUTOTB_TVIN_outStream_V_id_V_out_wrapc  "./rtl.yolo_yolo_top.autotvin_outStream_V_id_V.dat"
`define AUTOTB_TVIN_outStream_V_dest_V_out_wrapc  "./rtl.yolo_yolo_top.autotvin_outStream_V_dest_V.dat"
`define AUTOTB_TVIN_activate_en_V_out_wrapc  "./rtl.yolo_yolo_top.autotvin_activate_en_V.dat"
`define AUTOTB_TVIN_input_h_V_out_wrapc  "./rtl.yolo_yolo_top.autotvin_input_h_V.dat"
`define AUTOTB_TVIN_input_w_V_out_wrapc  "./rtl.yolo_yolo_top.autotvin_input_w_V.dat"
`define AUTOTB_TVOUT_outStream_V_data  "./c.yolo_yolo_top.autotvout_outStream_V_data.dat"
`define AUTOTB_TVOUT_outStream_V_keep_V  "./c.yolo_yolo_top.autotvout_outStream_V_keep_V.dat"
`define AUTOTB_TVOUT_outStream_V_strb_V  "./c.yolo_yolo_top.autotvout_outStream_V_strb_V.dat"
`define AUTOTB_TVOUT_outStream_V_user_V  "./c.yolo_yolo_top.autotvout_outStream_V_user_V.dat"
`define AUTOTB_TVOUT_outStream_V_last_V  "./c.yolo_yolo_top.autotvout_outStream_V_last_V.dat"
`define AUTOTB_TVOUT_outStream_V_id_V  "./c.yolo_yolo_top.autotvout_outStream_V_id_V.dat"
`define AUTOTB_TVOUT_outStream_V_dest_V  "./c.yolo_yolo_top.autotvout_outStream_V_dest_V.dat"
`define AUTOTB_TVOUT_outStream_V_data_out_wrapc  "./impl_rtl.yolo_yolo_top.autotvout_outStream_V_data.dat"
`define AUTOTB_TVOUT_outStream_V_keep_V_out_wrapc  "./impl_rtl.yolo_yolo_top.autotvout_outStream_V_keep_V.dat"
`define AUTOTB_TVOUT_outStream_V_strb_V_out_wrapc  "./impl_rtl.yolo_yolo_top.autotvout_outStream_V_strb_V.dat"
`define AUTOTB_TVOUT_outStream_V_user_V_out_wrapc  "./impl_rtl.yolo_yolo_top.autotvout_outStream_V_user_V.dat"
`define AUTOTB_TVOUT_outStream_V_last_V_out_wrapc  "./impl_rtl.yolo_yolo_top.autotvout_outStream_V_last_V.dat"
`define AUTOTB_TVOUT_outStream_V_id_V_out_wrapc  "./impl_rtl.yolo_yolo_top.autotvout_outStream_V_id_V.dat"
`define AUTOTB_TVOUT_outStream_V_dest_V_out_wrapc  "./impl_rtl.yolo_yolo_top.autotvout_outStream_V_dest_V.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 5440;
parameter LENGTH_inStream_V_data = 1352;
...
parameter LENGTH_outStream_V_data = 1352;
parameter LENGTH_outStream_V_keep_V = 1352;
parameter LENGTH_outStream_V_strb_V = 1352;
parameter LENGTH_outStream_V_user_V = 1352;
parameter LENGTH_outStream_V_last_V = 1352;
parameter LENGTH_outStream_V_id_V = 1352;
parameter LENGTH_outStream_V_dest_V = 1352;
parameter LENGTH_activate_en_V = 1;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.yolo_yolo_top.autotvout_outStream_V_data.dat", "r");
    fp2 = $fopen("./impl_rtl.yolo_yolo_top.autotvout_outStream_V_data.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.yolo_yolo_top.autotvout_outStream_V_data.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.yolo_yolo_top.autotvout_outStream_V_data.dat\"!");
    else begin
        $display("Comparing rtl.yolo_yolo_top.autotvout_outStream_V_data.dat with impl_rtl.yolo_yolo_top.autotvout_outStream_V_data.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.yolo_yolo_top.autotvout_outStream_V_keep_V.dat", "r");
    fp2 = $fopen("./impl_rtl.yolo_yolo_top.autotvout_outStream_V_keep_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.yolo_yolo_top.autotvout_outStream_V_keep_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.yolo_yolo_top.autotvout_outStream_V_keep_V.dat\"!");
    else begin
        $display("Comparing rtl.yolo_yolo_top.autotvout_outStream_V_keep_V.dat with impl_rtl.yolo_yolo_top.autotvout_outStream_V_keep_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.yolo_yolo_top.autotvout_outStream_V_strb_V.dat", "r");
    fp2 = $fopen("./impl_rtl.yolo_yolo_top.autotvout_outStream_V_strb_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.yolo_yolo_top.autotvout_outStream_V_strb_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.yolo_yolo_top.autotvout_outStream_V_strb_V.dat\"!");
    else begin
        $display("Comparing rtl.yolo_yolo_top.autotvout_outStream_V_strb_V.dat with impl_rtl.yolo_yolo_top.autotvout_outStream_V_strb_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.yolo_yolo_top.autotvout_outStream_V_user_V.dat", "r");
    fp2 = $fopen("./impl_rtl.yolo_yolo_top.autotvout_outStream_V_user_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.yolo_yolo_top.autotvout_outStream_V_user_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.yolo_yolo_top.autotvout_outStream_V_user_V.dat\"!");
    else begin
        $display("Comparing rtl.yolo_yolo_top.autotvout_outStream_V_user_V.dat with impl_rtl.yolo_yolo_top.autotvout_outStream_V_user_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.yolo_yolo_top.autotvout_outStream_V_last_V.dat", "r");
    fp2 = $fopen("./impl_rtl.yolo_yolo_top.autotvout_outStream_V_last_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.yolo_yolo_top.autotvout_outStream_V_last_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.yolo_yolo_top.autotvout_outStream_V_last_V.dat\"!");
    else begin
        $display("Comparing rtl.yolo_yolo_top.autotvout_outStream_V_last_V.dat with impl_rtl.yolo_yolo_top.autotvout_outStream_V_last_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.yolo_yolo_top.autotvout_outStream_V_id_V.dat", "r");
    fp2 = $fopen("./impl_rtl.yolo_yolo_top.autotvout_outStream_V_id_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.yolo_yolo_top.autotvout_outStream_V_id_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.yolo_yolo_top.autotvout_outStream_V_id_V.dat\"!");
    else begin
        $display("Comparing rtl.yolo_yolo_top.autotvout_outStream_V_id_V.dat with impl_rtl.yolo_yolo_top.autotvout_outStream_V_id_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.yolo_yolo_top.autotvout_outStream_V_dest_V.dat", "r");
    fp2 = $fopen("./impl_rtl.yolo_yolo_top.autotvout_outStream_V_dest_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.yolo_yolo_top.autotvout_outStream_V_dest_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.yolo_yolo_top.autotvout_outStream_V_dest_V.dat\"!");
    else begin
        $display("Comparing rtl.yolo_yolo_top.autotvout_outStream_V_dest_V.dat with impl_rtl.yolo_yolo_top.autotvout_outStream_V_dest_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
reg end_activate_en_V;
reg [31:0] size_activate_en_V;
reg [31:0] size_activate_en_V_backup;
reg end_input_h_V;
