<AutoPilot:project xmlns:AutoPilot="com.autoesl.autopilot.project" projectType="C/C++" name="yolo_max_pool_prj" top="yolo_max_pool_top">
    <Simulation argv="">
    ...
    <files>
        ...
        <file name="../../tb/yolo_max_pool_tb.cpp" sc="0" tb="1" cflags=" -Wno-unknown-pragmas" csimflags=" -Wno-unknown-pragmas" blackbox="false"/>
        ...
        <file name="src/yolo_max_pool.cpp" sc="0" tb="false" cflags="" csimflags="" blackbox="false"/>
