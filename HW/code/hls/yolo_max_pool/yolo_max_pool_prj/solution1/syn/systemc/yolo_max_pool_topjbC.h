...
// ==============================================================
#ifndef __yolo_max_pool_topjbC__HH__
#define __yolo_max_pool_topjbC__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(yolo_max_pool_topjbC) {
    ...
    SC_CTOR(yolo_max_pool_topjbC):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
