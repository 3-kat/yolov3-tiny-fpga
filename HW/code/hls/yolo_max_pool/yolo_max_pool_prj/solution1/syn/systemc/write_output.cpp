...
write_output::write_output(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( val_output_2_V );
    sensitive << ( val_output_3_V );
    sensitive << ( ap_ce );
    ...
    sc_trace(mVcdFile, val_output_2_V, "(port)val_output_2_V");
    sc_trace(mVcdFile, val_output_3_V, "(port)val_output_3_V");
...
void write_output::thread_outStream_TDATA() {
    outStream_TDATA = esl_concat<48,16>(esl_concat<32,16>(esl_concat<16,16>(val_output_3_V.read(), val_output_2_V.read()), val_output_1_V.read()), val_output_0_V.read());
}
