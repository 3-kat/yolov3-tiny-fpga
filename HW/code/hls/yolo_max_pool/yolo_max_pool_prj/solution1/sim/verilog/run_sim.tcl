...
if {[file isfile yolo_max_pool_top.autotvin.dat]} {
	file delete -force yolo_max_pool_top.autotvin.dat
}

if {[file isfile yolo_max_pool_top.autotvout.dat]} {
	file delete -force yolo_max_pool_top.autotvout.dat
}
