...
`define AESL_DEPTH_output_h_V 1
`define AESL_DEPTH_output_w_V 1
`define AESL_DEPTH_input_h_V 1
`define AESL_DEPTH_input_w_V 1
`define AESL_DEPTH_input_fold_ch_V 1
`define AESL_DEPTH_stride_V 1
...
`define AUTOTB_TVIN_inStream_V_data_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvin_inStream_V_data.dat"
`define AUTOTB_TVIN_inStream_V_keep_V_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvin_inStream_V_keep_V.dat"
`define AUTOTB_TVIN_inStream_V_strb_V_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvin_inStream_V_strb_V.dat"
`define AUTOTB_TVIN_inStream_V_user_V_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvin_inStream_V_user_V.dat"
`define AUTOTB_TVIN_inStream_V_last_V_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvin_inStream_V_last_V.dat"
`define AUTOTB_TVIN_inStream_V_id_V_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvin_inStream_V_id_V.dat"
`define AUTOTB_TVIN_inStream_V_dest_V_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvin_inStream_V_dest_V.dat"
`define AUTOTB_TVIN_outStream_V_data_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvin_outStream_V_data.dat"
`define AUTOTB_TVIN_outStream_V_keep_V_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvin_outStream_V_keep_V.dat"
`define AUTOTB_TVIN_outStream_V_strb_V_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvin_outStream_V_strb_V.dat"
`define AUTOTB_TVIN_outStream_V_user_V_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvin_outStream_V_user_V.dat"
`define AUTOTB_TVIN_outStream_V_last_V_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvin_outStream_V_last_V.dat"
`define AUTOTB_TVIN_outStream_V_id_V_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvin_outStream_V_id_V.dat"
`define AUTOTB_TVIN_outStream_V_dest_V_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvin_outStream_V_dest_V.dat"
`define AUTOTB_TVIN_output_h_V_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvin_output_h_V.dat"
`define AUTOTB_TVIN_output_w_V_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvin_output_w_V.dat"
`define AUTOTB_TVIN_input_h_V_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvin_input_h_V.dat"
`define AUTOTB_TVIN_input_w_V_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvin_input_w_V.dat"
`define AUTOTB_TVIN_input_fold_ch_V_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvin_input_fold_ch_V.dat"
`define AUTOTB_TVIN_stride_V_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvin_stride_V.dat"
...
`define AUTOTB_TVOUT_outStream_V_data_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvout_outStream_V_data.dat"
`define AUTOTB_TVOUT_outStream_V_keep_V_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvout_outStream_V_keep_V.dat"
`define AUTOTB_TVOUT_outStream_V_strb_V_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvout_outStream_V_strb_V.dat"
`define AUTOTB_TVOUT_outStream_V_user_V_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvout_outStream_V_user_V.dat"
`define AUTOTB_TVOUT_outStream_V_last_V_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvout_outStream_V_last_V.dat"
`define AUTOTB_TVOUT_outStream_V_id_V_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvout_outStream_V_id_V.dat"
`define AUTOTB_TVOUT_outStream_V_dest_V_out_wrapc  "../tv/rtldatafile/rtl.yolo_max_pool_top.autotvout_outStream_V_dest_V.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 1384491;
parameter LENGTH_inStream_V_data = 692224;
parameter LENGTH_inStream_V_keep_V = 692224;
parameter LENGTH_inStream_V_strb_V = 692224;
parameter LENGTH_inStream_V_user_V = 692224;
parameter LENGTH_inStream_V_last_V = 692224;
parameter LENGTH_inStream_V_id_V = 692224;
parameter LENGTH_inStream_V_dest_V = 692224;
parameter LENGTH_outStream_V_data = 173056;
parameter LENGTH_outStream_V_keep_V = 173056;
parameter LENGTH_outStream_V_strb_V = 173056;
parameter LENGTH_outStream_V_user_V = 173056;
parameter LENGTH_outStream_V_last_V = 173056;
parameter LENGTH_outStream_V_id_V = 173056;
parameter LENGTH_outStream_V_dest_V = 173056;
parameter LENGTH_output_h_V = 1;
parameter LENGTH_output_w_V = 1;
parameter LENGTH_input_h_V = 1;
parameter LENGTH_input_w_V = 1;
parameter LENGTH_input_fold_ch_V = 1;
parameter LENGTH_stride_V = 1;
...
reg end_output_h_V;
reg [31:0] size_output_h_V;
reg [31:0] size_output_h_V_backup;
reg end_output_w_V;
reg [31:0] size_output_w_V;
reg [31:0] size_output_w_V_backup;
reg end_input_h_V;
...
reg end_input_fold_ch_V;
reg [31:0] size_input_fold_ch_V;
reg [31:0] size_input_fold_ch_V_backup;
reg end_stride_V;
reg [31:0] size_stride_V;
reg [31:0] size_stride_V_backup;
