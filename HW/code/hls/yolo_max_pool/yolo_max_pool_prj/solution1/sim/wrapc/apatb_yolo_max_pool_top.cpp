...
// wrapc file define: "output_h_V"
#define AUTOTB_TVIN_output_h_V  "../tv/cdatafile/c.yolo_max_pool_top.autotvin_output_h_V.dat"
// wrapc file define: "output_w_V"
#define AUTOTB_TVIN_output_w_V  "../tv/cdatafile/c.yolo_max_pool_top.autotvin_output_w_V.dat"
// wrapc file define: "input_h_V"
#define AUTOTB_TVIN_input_h_V  "../tv/cdatafile/c.yolo_max_pool_top.autotvin_input_h_V.dat"
// wrapc file define: "input_w_V"
#define AUTOTB_TVIN_input_w_V  "../tv/cdatafile/c.yolo_max_pool_top.autotvin_input_w_V.dat"
// wrapc file define: "input_fold_ch_V"
#define AUTOTB_TVIN_input_fold_ch_V  "../tv/cdatafile/c.yolo_max_pool_top.autotvin_input_fold_ch_V.dat"
// wrapc file define: "stride_V"
#define AUTOTB_TVIN_stride_V  "../tv/cdatafile/c.yolo_max_pool_top.autotvin_stride_V.dat"
...
class INTER_TCL_FILE {
	public:
		...
		string get_depth_list () {
			...
			total_list << "{output_h_V " << output_h_V_depth << "}\n";
			total_list << "{output_w_V " << output_w_V_depth << "}\n";
			total_list << "{input_h_V " << input_h_V_depth << "}\n";
			total_list << "{input_w_V " << input_w_V_depth << "}\n";
			total_list << "{input_fold_ch_V " << input_fold_ch_V_depth << "}\n";
			total_list << "{stride_V " << stride_V_depth << "}\n";
	...
	public:
		...
		int output_h_V_depth;
		int output_w_V_depth;
		int input_h_V_depth;
		int input_w_V_depth;
		int input_fold_ch_V_depth;
		int stride_V_depth;
		int trans_num;
...
ap_uint<2> stride)
{
	...
	else
	{
		...
		// "output_h_V"
		char* tvin_output_h_V = new char[50];
		aesl_fh.touch(AUTOTB_TVIN_output_h_V);

		// "output_w_V"
		char* tvin_output_w_V = new char[50];
		aesl_fh.touch(AUTOTB_TVIN_output_w_V);
		...
		// "input_fold_ch_V"
		char* tvin_input_fold_ch_V = new char[50];
		aesl_fh.touch(AUTOTB_TVIN_input_fold_ch_V);

		// "stride_V"
		char* tvin_stride_V = new char[50];
		aesl_fh.touch(AUTOTB_TVIN_stride_V);
		...
		// [[transaction]]
		sprintf(tvin_output_h_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_output_h_V, tvin_output_h_V);

		sc_bv<9> output_h_V_tvin_wrapc_buffer;

		// RTL Name: output_h_V
		{
			// bitslice(8, 0)
			{
				// celement: output_h.V(8, 0)
				{
					// carray: (0) => (0) @ (0)
					{
						// sub                   : 
						// ori_name              : output_h
						// sub_1st_elem          : 
						// ori_name_1st_elem     : output_h
						// regulate_c_name       : output_h_V
						// input_type_conversion : (output_h).to_string(2).c_str()
						if (&(output_h) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<9> output_h_V_tmp_mem;
							output_h_V_tmp_mem = (output_h).to_string(2).c_str();
							output_h_V_tvin_wrapc_buffer.range(8, 0) = output_h_V_tmp_mem.range(8, 0);
						}
					}
				}
			}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_output_h_V, "%s\n", (output_h_V_tvin_wrapc_buffer).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_output_h_V, tvin_output_h_V);
		}

		tcl_file.set_num(1, &tcl_file.output_h_V_depth);
		sprintf(tvin_output_h_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_output_h_V, tvin_output_h_V);

		// [[transaction]]
		sprintf(tvin_output_w_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_output_w_V, tvin_output_w_V);

		sc_bv<9> output_w_V_tvin_wrapc_buffer;

		// RTL Name: output_w_V
		{
			// bitslice(8, 0)
			{
				// celement: output_w.V(8, 0)
				{
					// carray: (0) => (0) @ (0)
					{
						// sub                   : 
						// ori_name              : output_w
						// sub_1st_elem          : 
						// ori_name_1st_elem     : output_w
						// regulate_c_name       : output_w_V
						// input_type_conversion : (output_w).to_string(2).c_str()
						if (&(output_w) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<9> output_w_V_tmp_mem;
							output_w_V_tmp_mem = (output_w).to_string(2).c_str();
							output_w_V_tvin_wrapc_buffer.range(8, 0) = output_w_V_tmp_mem.range(8, 0);
						}
					}
				}
			}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_output_w_V, "%s\n", (output_w_V_tvin_wrapc_buffer).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_output_w_V, tvin_output_w_V);
		}

		tcl_file.set_num(1, &tcl_file.output_w_V_depth);
		sprintf(tvin_output_w_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_output_w_V, tvin_output_w_V);
		...
		// [[transaction]]
		sprintf(tvin_input_fold_ch_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_input_fold_ch_V, tvin_input_fold_ch_V);

		sc_bv<4> input_fold_ch_V_tvin_wrapc_buffer;

		// RTL Name: input_fold_ch_V
		{
			// bitslice(3, 0)
			{
				// celement: input_fold_ch.V(3, 0)
				{
					// carray: (0) => (0) @ (0)
					{
						// sub                   : 
						// ori_name              : input_fold_ch
						// sub_1st_elem          : 
						// ori_name_1st_elem     : input_fold_ch
						// regulate_c_name       : input_fold_ch_V
						// input_type_conversion : (input_fold_ch).to_string(2).c_str()
						if (&(input_fold_ch) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<4> input_fold_ch_V_tmp_mem;
							input_fold_ch_V_tmp_mem = (input_fold_ch).to_string(2).c_str();
							input_fold_ch_V_tvin_wrapc_buffer.range(3, 0) = input_fold_ch_V_tmp_mem.range(3, 0);
						}
					}
				}
			}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_input_fold_ch_V, "%s\n", (input_fold_ch_V_tvin_wrapc_buffer).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_input_fold_ch_V, tvin_input_fold_ch_V);
		}

		tcl_file.set_num(1, &tcl_file.input_fold_ch_V_depth);
		sprintf(tvin_input_fold_ch_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_input_fold_ch_V, tvin_input_fold_ch_V);

		// [[transaction]]
		sprintf(tvin_stride_V, "[[transaction]] %d\n", AESL_transaction);
		aesl_fh.write(AUTOTB_TVIN_stride_V, tvin_stride_V);

		sc_bv<2> stride_V_tvin_wrapc_buffer;

		// RTL Name: stride_V
		{
			// bitslice(1, 0)
			{
				// celement: stride.V(1, 0)
				{
					// carray: (0) => (0) @ (0)
					{
						// sub                   : 
						...
						// regulate_c_name       : stride_V
						// input_type_conversion : (stride).to_string(2).c_str()
						if (&(stride) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<2> stride_V_tmp_mem;
							stride_V_tmp_mem = (stride).to_string(2).c_str();
							stride_V_tvin_wrapc_buffer.range(1, 0) = stride_V_tmp_mem.range(1, 0);
						}
					}
				}
			}
		...
		for (int i = 0; i < 1; i++)
		{
			sprintf(tvin_stride_V, "%s\n", (stride_V_tvin_wrapc_buffer).to_string(SC_HEX).c_str());
			aesl_fh.write(AUTOTB_TVIN_stride_V, tvin_stride_V);
		}

		tcl_file.set_num(1, &tcl_file.stride_V_depth);
		sprintf(tvin_stride_V, "[[/transaction]] \n");
		aesl_fh.write(AUTOTB_TVIN_stride_V, tvin_stride_V);
...
// [call_c_dut] ---------->
		...
		yolo_max_pool_top(inStream, outStream, output_h, output_w, input_h, input_w, input_fold_ch, stride);
     ...
     if (aesl_tmp_7 > aesl_tmp_8)
     {
		...
		// release memory allocation: "output_h_V"
		delete [] tvin_output_h_V;
		// release memory allocation: "output_w_V"
		delete [] tvin_output_w_V;
		// release memory allocation: "input_h_V"
		delete [] tvin_input_h_V;
		// release memory allocation: "input_w_V"
		delete [] tvin_input_w_V;
		// release memory allocation: "input_fold_ch_V"
		delete [] tvin_input_fold_ch_V;
		// release memory allocation: "stride_V"
		delete [] tvin_stride_V;
