...
`define AUTOTB_TVIN_output_h_V  "./c.yolo_max_pool_top.autotvin_output_h_V.dat"
`define AUTOTB_TVIN_output_w_V  "./c.yolo_max_pool_top.autotvin_output_w_V.dat"
`define AUTOTB_TVIN_input_h_V  "./c.yolo_max_pool_top.autotvin_input_h_V.dat"
`define AUTOTB_TVIN_input_w_V  "./c.yolo_max_pool_top.autotvin_input_w_V.dat"
`define AUTOTB_TVIN_input_fold_ch_V  "./c.yolo_max_pool_top.autotvin_input_fold_ch_V.dat"
`define AUTOTB_TVIN_stride_V  "./c.yolo_max_pool_top.autotvin_stride_V.dat"
...
`define AUTOTB_TVIN_output_h_V_out_wrapc  "./rtl.yolo_max_pool_top.autotvin_output_h_V.dat"
`define AUTOTB_TVIN_output_w_V_out_wrapc  "./rtl.yolo_max_pool_top.autotvin_output_w_V.dat"
`define AUTOTB_TVIN_input_h_V_out_wrapc  "./rtl.yolo_max_pool_top.autotvin_input_h_V.dat"
`define AUTOTB_TVIN_input_w_V_out_wrapc  "./rtl.yolo_max_pool_top.autotvin_input_w_V.dat"
`define AUTOTB_TVIN_input_fold_ch_V_out_wrapc  "./rtl.yolo_max_pool_top.autotvin_input_fold_ch_V.dat"
`define AUTOTB_TVIN_stride_V_out_wrapc  "./rtl.yolo_max_pool_top.autotvin_stride_V.dat"
