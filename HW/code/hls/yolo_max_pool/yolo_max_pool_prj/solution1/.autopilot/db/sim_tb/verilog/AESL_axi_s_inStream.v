...
`define TV_IN_inStream_TDATA "./c.yolo_max_pool_top.autotvin_inStream_V_data.dat"
`define INGRESS_STATUS_inStream_TDATA "./stream_ingress_status_inStream_V_data.dat"
`define TV_IN_inStream_TKEEP "./c.yolo_max_pool_top.autotvin_inStream_V_keep_V.dat"
`define INGRESS_STATUS_inStream_TKEEP "./stream_ingress_status_inStream_V_keep_V.dat"
`define TV_IN_inStream_TSTRB "./c.yolo_max_pool_top.autotvin_inStream_V_strb_V.dat"
`define INGRESS_STATUS_inStream_TSTRB "./stream_ingress_status_inStream_V_strb_V.dat"
`define TV_IN_inStream_TUSER "./c.yolo_max_pool_top.autotvin_inStream_V_user_V.dat"
`define INGRESS_STATUS_inStream_TUSER "./stream_ingress_status_inStream_V_user_V.dat"
`define TV_IN_inStream_TLAST "./c.yolo_max_pool_top.autotvin_inStream_V_last_V.dat"
`define INGRESS_STATUS_inStream_TLAST "./stream_ingress_status_inStream_V_last_V.dat"
`define TV_IN_inStream_TID "./c.yolo_max_pool_top.autotvin_inStream_V_id_V.dat"
`define INGRESS_STATUS_inStream_TID "./stream_ingress_status_inStream_V_id_V.dat"
`define TV_IN_inStream_TDEST "./c.yolo_max_pool_top.autotvin_inStream_V_dest_V.dat"
...
module AESL_axi_s_inStream (
    ...
    fifo #(692224, 64) fifo_inStream_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(692224, 8) fifo_inStream_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(692224, 8) fifo_inStream_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(692224, 2) fifo_inStream_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(692224, 1) fifo_inStream_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(692224, 5) fifo_inStream_TID (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(692224, 6) fifo_inStream_TDEST (
        .reset(1'b0),
        .write_clock(clk),
