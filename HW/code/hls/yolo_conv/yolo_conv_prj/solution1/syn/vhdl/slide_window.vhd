...
architecture behav of slide_window is 
    ...
    signal conv_count_read_reg_249 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_block_state1_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state4_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal mul_ln261_fu_139_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal mul_ln261_reg_255 : STD_LOGIC_VECTOR (12 downto 0);
    signal add_ln261_fu_145_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal add_ln261_reg_262 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_CS_fsm_pp0_stage1 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_pp0_stage1 : signal is "none";
    signal ap_block_state2_pp0_stage1_iter0 : BOOLEAN;
    signal ap_block_pp0_stage1_11001 : BOOLEAN;
    signal add_ln261_4_fu_190_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal add_ln261_4_reg_297 : STD_LOGIC_VECTOR (12 downto 0);
    signal line_buff_val_0_V_l_reg_302 : STD_LOGIC_VECTOR (15 downto 0);
    signal line_buff_val_0_V_l_1_reg_307 : STD_LOGIC_VECTOR (15 downto 0);
    signal line_buff_val_1_V_l_reg_327 : STD_LOGIC_VECTOR (15 downto 0);
    signal line_buff_val_1_V_l_1_reg_332 : STD_LOGIC_VECTOR (15 downto 0);
    signal line_buff_val_2_V_l_reg_337 : STD_LOGIC_VECTOR (15 downto 0);
    signal line_buff_val_2_V_l_1_reg_342 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_enable_reg_pp0_iter0_reg : STD_LOGIC := '0';
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal ap_block_pp0_stage2_subdone : BOOLEAN;
    signal sext_ln261_fu_159_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage1 : BOOLEAN;
    signal sext_ln261_1_fu_174_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal sext_ln261_2_fu_195_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage2 : BOOLEAN;
    signal mul_ln261_fu_139_p0 : STD_LOGIC_VECTOR (3 downto 0);
    signal zext_ln261_1_fu_151_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal add_ln261_2_fu_154_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal zext_ln261_2_fu_166_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal add_ln261_3_fu_169_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal add_ln261_1_fu_181_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal zext_ln261_3_fu_186_p1 : STD_LOGIC_VECTOR (12 downto 0);
    ...
    signal mul_ln261_fu_139_p00 : STD_LOGIC_VECTOR (12 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_ce) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1_11001))) then
                add_ln261_4_reg_297 <= add_ln261_4_fu_190_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_ce) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                add_ln261_reg_262 <= add_ln261_fu_145_p2;
                conv_count_read_reg_249 <= conv_count;
                    mul_ln261_reg_255(12 downto 1) <= mul_ln261_fu_139_p2(12 downto 1);
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln261_1_fu_181_p2 <= std_logic_vector(unsigned(conv_count_read_reg_249) + unsigned(ap_const_lv9_2));
    add_ln261_2_fu_154_p2 <= std_logic_vector(unsigned(zext_ln261_1_fu_151_p1) + unsigned(mul_ln261_reg_255));
    add_ln261_3_fu_169_p2 <= std_logic_vector(unsigned(zext_ln261_2_fu_166_p1) + unsigned(mul_ln261_reg_255));
    add_ln261_4_fu_190_p2 <= std_logic_vector(unsigned(zext_ln261_3_fu_186_p1) + unsigned(mul_ln261_reg_255));
    add_ln261_fu_145_p2 <= std_logic_vector(unsigned(conv_count) + unsigned(ap_const_lv9_1));
    ...
    ap_return_0 <= line_buff_val_0_V_l_reg_302;
    ap_return_1 <= line_buff_val_0_V_l_1_reg_307;
    ap_return_2 <= line_buff_val_0_V_q0;
    ap_return_3 <= line_buff_val_1_V_l_reg_327;
    ap_return_4 <= line_buff_val_1_V_l_1_reg_332;
    ap_return_5 <= line_buff_val_1_V_q0;
    ap_return_6 <= line_buff_val_2_V_l_reg_337;
    ap_return_7 <= line_buff_val_2_V_l_1_reg_342;
    ap_return_8 <= line_buff_val_2_V_q0;

    line_buff_val_0_V_address0_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage2, ap_CS_fsm_pp0_stage1, sext_ln261_fu_159_p1, ap_block_pp0_stage1, sext_ln261_2_fu_195_p1, ap_block_pp0_stage2)
    begin
        if ((ap_enable_reg_pp0_iter0 = ap_const_logic_1)) then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage2) and (ap_const_boolean_0 = ap_block_pp0_stage2))) then 
                line_buff_val_0_V_address0 <= sext_ln261_2_fu_195_p1(12 - 1 downto 0);
            elsif (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1))) then 
                line_buff_val_0_V_address0 <= sext_ln261_fu_159_p1(12 - 1 downto 0);
            else 
    ...
    line_buff_val_0_V_address1 <= sext_ln261_1_fu_174_p1(12 - 1 downto 0);
    ...
    line_buff_val_1_V_address0_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage2, ap_CS_fsm_pp0_stage1, sext_ln261_fu_159_p1, ap_block_pp0_stage1, sext_ln261_2_fu_195_p1, ap_block_pp0_stage2)
    begin
        if ((ap_enable_reg_pp0_iter0 = ap_const_logic_1)) then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage2) and (ap_const_boolean_0 = ap_block_pp0_stage2))) then 
                line_buff_val_1_V_address0 <= sext_ln261_2_fu_195_p1(12 - 1 downto 0);
            elsif (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1))) then 
                line_buff_val_1_V_address0 <= sext_ln261_fu_159_p1(12 - 1 downto 0);
            else 
    ...
    line_buff_val_1_V_address1 <= sext_ln261_1_fu_174_p1(12 - 1 downto 0);
    ...
    line_buff_val_2_V_address0_assign_proc : process(ap_enable_reg_pp0_iter0, ap_CS_fsm_pp0_stage2, ap_CS_fsm_pp0_stage1, sext_ln261_fu_159_p1, ap_block_pp0_stage1, sext_ln261_2_fu_195_p1, ap_block_pp0_stage2)
    begin
        if ((ap_enable_reg_pp0_iter0 = ap_const_logic_1)) then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage2) and (ap_const_boolean_0 = ap_block_pp0_stage2))) then 
                line_buff_val_2_V_address0 <= sext_ln261_2_fu_195_p1(12 - 1 downto 0);
            elsif (((ap_const_logic_1 = ap_CS_fsm_pp0_stage1) and (ap_const_boolean_0 = ap_block_pp0_stage1))) then 
                line_buff_val_2_V_address0 <= sext_ln261_fu_159_p1(12 - 1 downto 0);
            else 
    ...
    line_buff_val_2_V_address1 <= sext_ln261_1_fu_174_p1(12 - 1 downto 0);
    ...
    mul_ln261_fu_139_p0 <= mul_ln261_fu_139_p00(4 - 1 downto 0);
    mul_ln261_fu_139_p00 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(line_buff_val_V_offset),13));
    mul_ln261_fu_139_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(mul_ln261_fu_139_p0) * unsigned(ap_const_lv13_1A2), 13));
        sext_ln261_1_fu_174_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(add_ln261_3_fu_169_p2),64));

        sext_ln261_2_fu_195_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(add_ln261_4_reg_297),64));

        sext_ln261_fu_159_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(add_ln261_2_fu_154_p2),64));

    zext_ln261_1_fu_151_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(conv_count_read_reg_249),13));
    zext_ln261_2_fu_166_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln261_reg_262),13));
    zext_ln261_3_fu_186_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln261_1_fu_181_p2),13));
end behav;
