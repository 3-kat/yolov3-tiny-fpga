...
entity yolo_conv_top_CTRL_BUS_s_axi is
generic (
...
--        bit 1  - Channel 1 (ap_ready)
--        others - reserved
-- 0x10 : Data signal of output_ch_V
--        bit 5~0 - output_ch_V[5:0] (Read/Write)
--        others  - reserved
-- 0x14 : reserved
-- 0x18 : Data signal of input_ch_V
--        bit 5~0 - input_ch_V[5:0] (Read/Write)
--        others  - reserved
-- 0x1c : reserved
-- 0x20 : Data signal of fold_output_ch_V
--        bit 3~0 - fold_output_ch_V[3:0] (Read/Write)
--        others  - reserved
-- 0x24 : reserved
-- 0x28 : Data signal of fold_input_ch_V
...
architecture behave of yolo_conv_top_CTRL_BUS_s_axi is
    ...
    constant ADDR_OUTPUT_CH_V_DATA_0      : INTEGER := 16#10#;
    constant ADDR_OUTPUT_CH_V_CTRL        : INTEGER := 16#14#;
    constant ADDR_INPUT_CH_V_DATA_0       : INTEGER := 16#18#;
    constant ADDR_INPUT_CH_V_CTRL         : INTEGER := 16#1c#;
    constant ADDR_FOLD_OUTPUT_CH_V_DATA_0 : INTEGER := 16#20#;
    constant ADDR_FOLD_OUTPUT_CH_V_CTRL   : INTEGER := 16#24#;
    constant ADDR_FOLD_INPUT_CH_V_DATA_0  : INTEGER := 16#28#;
    constant ADDR_FOLD_INPUT_CH_V_CTRL    : INTEGER := 16#2c#;
    constant ADDR_INPUT_H_V_DATA_0        : INTEGER := 16#30#;
    constant ADDR_INPUT_H_V_CTRL          : INTEGER := 16#34#;
    constant ADDR_INPUT_W_V_DATA_0        : INTEGER := 16#38#;
    ...
    signal int_output_ch_V     : UNSIGNED(5 downto 0) := (others => '0');
    signal int_input_ch_V      : UNSIGNED(5 downto 0) := (others => '0');
    signal int_fold_output_ch_V : UNSIGNED(3 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_OUTPUT_CH_V_DATA_0 =>
                        rdata_data <= RESIZE(int_output_ch_V(5 downto 0), 32);
                    when ADDR_INPUT_CH_V_DATA_0 =>
                        rdata_data <= RESIZE(int_input_ch_V(5 downto 0), 32);
                    when ADDR_FOLD_OUTPUT_CH_V_DATA_0 =>
                        rdata_data <= RESIZE(int_fold_output_ch_V(3 downto 0), 32);
...
-- ----------------------- Register logic ----------------
    ...
    output_ch_V          <= STD_LOGIC_VECTOR(int_output_ch_V);
    input_ch_V           <= STD_LOGIC_VECTOR(int_input_ch_V);
    fold_output_ch_V     <= STD_LOGIC_VECTOR(int_fold_output_ch_V);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_OUTPUT_CH_V_DATA_0) then
                    int_output_ch_V(5 downto 0) <= (UNSIGNED(WDATA(5 downto 0)) and wmask(5 downto 0)) or ((not wmask(5 downto 0)) and int_output_ch_V(5 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_INPUT_CH_V_DATA_0) then
                    int_input_ch_V(5 downto 0) <= (UNSIGNED(WDATA(5 downto 0)) and wmask(5 downto 0)) or ((not wmask(5 downto 0)) and int_input_ch_V(5 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_FOLD_OUTPUT_CH_V_DATA_0) then
                    int_fold_output_ch_V(3 downto 0) <= (UNSIGNED(WDATA(3 downto 0)) and wmask(3 downto 0)) or ((not wmask(3 downto 0)) and int_fold_output_ch_V(3 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_FOLD_WIN_AREA_V_DATA_0) then
                    int_fold_win_area_V(2 downto 0) <= (UNSIGNED(WDATA(2 downto 0)) and wmask(2 downto 0)) or ((not wmask(2 downto 0)) and int_fold_win_area_V(2 downto 0));
                end if;
            end if;
        end if;
    end process;
