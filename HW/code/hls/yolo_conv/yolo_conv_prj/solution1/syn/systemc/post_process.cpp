...
void post_process::thread_icmp_ln213_fu_56_p2() {
    icmp_ln213_fu_56_p2 = (!input_ch_idx.read().is_01() || !ap_const_lv4_0.is_01())? sc_lv<1>(): sc_lv<1>(input_ch_idx.read() == ap_const_lv4_0);
}

void post_process::thread_p_Val2_s_fu_62_p3() {
    p_Val2_s_fu_62_p3 = (!icmp_ln213_fu_56_p2.read()[0].is_01())? sc_lv<32>(): ((icmp_ln213_fu_56_p2.read()[0].to_bool())? ap_const_lv32_0: val_output_V.read());
}
