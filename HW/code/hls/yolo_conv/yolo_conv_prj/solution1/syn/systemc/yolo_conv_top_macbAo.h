...
// ==============================================================
#ifndef __yolo_conv_top_macbAo__HH__
#define __yolo_conv_top_macbAo__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(yolo_conv_top_macbAo) {
    ...
    SC_CTOR(yolo_conv_top_macbAo):  simcore_mac_1_U ("simcore_mac_1_U") {
