...
// ==============================================================
#ifndef __yolo_conv_top_am_bzo__HH__
#define __yolo_conv_top_am_bzo__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(yolo_conv_top_am_bzo) {
    ...
    SC_CTOR(yolo_conv_top_am_bzo):  simcore_am_0_U ("simcore_am_0_U") {
