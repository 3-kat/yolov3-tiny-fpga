...
// ==============================================================
#ifndef __yolo_conv_top_maccud__HH__
#define __yolo_conv_top_maccud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(yolo_conv_top_maccud) {
    ...
    SC_CTOR(yolo_conv_top_maccud):  simcore_mac_0_U ("simcore_mac_0_U") {
