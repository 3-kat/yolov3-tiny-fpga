...
window_macc::window_macc(sc_module_name name) : sc_module(name), mVcdFile(0) {
    yolo_conv_top_mulbkb_U6 = new yolo_conv_top_mulbkb<1,1,16,16,32>("yolo_conv_top_mulbkb_U6");
    yolo_conv_top_mulbkb_U6->din0(p_read1_int_reg);
    yolo_conv_top_mulbkb_U6->din1(p_read10_int_reg);
    yolo_conv_top_mulbkb_U6->dout(mul_ln1118_1_fu_221_p2);
    yolo_conv_top_mulbkb_U7 = new yolo_conv_top_mulbkb<1,1,16,16,32>("yolo_conv_top_mulbkb_U7");
    yolo_conv_top_mulbkb_U7->din0(p_read2_int_reg);
    yolo_conv_top_mulbkb_U7->din1(p_read11_int_reg);
    yolo_conv_top_mulbkb_U7->dout(mul_ln1118_2_fu_227_p2);
    yolo_conv_top_mulbkb_U8 = new yolo_conv_top_mulbkb<1,1,16,16,32>("yolo_conv_top_mulbkb_U8");
    yolo_conv_top_mulbkb_U8->din0(p_read4_int_reg);
    yolo_conv_top_mulbkb_U8->din1(p_read13_int_reg);
    yolo_conv_top_mulbkb_U8->dout(mul_ln1118_4_fu_233_p2);
    yolo_conv_top_mulbkb_U9 = new yolo_conv_top_mulbkb<1,1,16,16,32>("yolo_conv_top_mulbkb_U9");
    yolo_conv_top_mulbkb_U9->din0(p_read7_int_reg);
    yolo_conv_top_mulbkb_U9->din1(p_read16_int_reg);
    yolo_conv_top_mulbkb_U9->dout(mul_ln1118_7_fu_239_p2);
    yolo_conv_top_maccud_U10 = new yolo_conv_top_maccud<1,1,16,16,32,32>("yolo_conv_top_maccud_U10");
    yolo_conv_top_maccud_U10->din0(p_read18_reg_326);
    yolo_conv_top_maccud_U10->din1(p_read_9_reg_301);
    yolo_conv_top_maccud_U10->din2(mul_ln1118_1_reg_331);
    yolo_conv_top_maccud_U10->dout(grp_fu_245_p3);
    yolo_conv_top_maccud_U11 = new yolo_conv_top_maccud<1,1,16,16,32,32>("yolo_conv_top_maccud_U11");
    yolo_conv_top_maccud_U11->din0(p_read_15_reg_321);
    yolo_conv_top_maccud_U11->din1(p_read_6_reg_296);
    yolo_conv_top_maccud_U11->din2(mul_ln1118_2_reg_336);
    yolo_conv_top_maccud_U11->dout(grp_fu_252_p3);
    yolo_conv_top_maccud_U12 = new yolo_conv_top_maccud<1,1,16,16,32,32>("yolo_conv_top_maccud_U12");
    yolo_conv_top_maccud_U12->din0(p_read_13_reg_316);
    yolo_conv_top_maccud_U12->din1(p_read_4_reg_291);
    yolo_conv_top_maccud_U12->din2(mul_ln1118_4_reg_341);
    yolo_conv_top_maccud_U12->dout(grp_fu_259_p3);
    yolo_conv_top_maccud_U13 = new yolo_conv_top_maccud<1,1,16,16,32,32>("yolo_conv_top_maccud_U13");
    yolo_conv_top_maccud_U13->din0(p_read_10_reg_306);
    yolo_conv_top_maccud_U13->din1(p_read_1_reg_281);
    yolo_conv_top_maccud_U13->din2(mul_ln1118_7_reg_346);
    yolo_conv_top_maccud_U13->dout(grp_fu_266_p3);
    yolo_conv_top_maccud_U14 = new yolo_conv_top_maccud<1,1,16,16,32,32>("yolo_conv_top_maccud_U14");
    yolo_conv_top_maccud_U14->din0(p_read_12_reg_311_pp0_iter1_reg);
    yolo_conv_top_maccud_U14->din1(p_read_3_reg_286_pp0_iter1_reg);
    yolo_conv_top_maccud_U14->din2(add_ln703_4_reg_366);
    yolo_conv_top_maccud_U14->dout(grp_fu_273_p3);
...
window_macc::~window_macc() {
    ...
    delete yolo_conv_top_mulbkb_U6;
    delete yolo_conv_top_mulbkb_U7;
    delete yolo_conv_top_mulbkb_U8;
    delete yolo_conv_top_mulbkb_U9;
    delete yolo_conv_top_maccud_U10;
    delete yolo_conv_top_maccud_U11;
    delete yolo_conv_top_maccud_U12;
    delete yolo_conv_top_maccud_U13;
    delete yolo_conv_top_maccud_U14;
}
