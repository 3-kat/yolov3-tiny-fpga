...
// ==============================================================
#ifndef __yolo_conv_top_mulbkb__HH__
#define __yolo_conv_top_mulbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(yolo_conv_top_mulbkb) {
    ...
    SC_CTOR(yolo_conv_top_mulbkb):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
