...
localparam
    ...
    ADDR_IER                     = 7'h08,
    ADDR_ISR                     = 7'h0c,
    ADDR_OUTPUT_CH_V_DATA_0      = 7'h10,
    ADDR_OUTPUT_CH_V_CTRL        = 7'h14,
    ADDR_INPUT_CH_V_DATA_0       = 7'h18,
    ADDR_INPUT_CH_V_CTRL         = 7'h1c,
    ADDR_FOLD_OUTPUT_CH_V_DATA_0 = 7'h20,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_OUTPUT_CH_V_DATA_0: begin
                    rdata <= int_output_ch_V[5:0];
                end
                ADDR_INPUT_CH_V_DATA_0: begin
                    rdata <= int_input_ch_V[5:0];
                end
                ADDR_FOLD_OUTPUT_CH_V_DATA_0: begin
                    rdata <= int_fold_output_ch_V[3:0];
                end
...
assign output_ch_V      = int_output_ch_V;
...
always @(posedge ACLK) begin
    if (ARESET)
        int_output_ch_V[5:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_OUTPUT_CH_V_DATA_0)
            int_output_ch_V[5:0] <= (WDATA[31:0] & wmask) | (int_output_ch_V[5:0] & ~wmask);
    end
end
...
always @(posedge ACLK) begin
    if (ARESET)
        int_input_ch_V[5:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_INPUT_CH_V_DATA_0)
            int_input_ch_V[5:0] <= (WDATA[31:0] & wmask) | (int_input_ch_V[5:0] & ~wmask);
    end
end

// int_fold_output_ch_V[3:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_fold_output_ch_V[3:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_FOLD_OUTPUT_CH_V_DATA_0)
            int_fold_output_ch_V[3:0] <= (WDATA[31:0] & wmask) | (int_fold_output_ch_V[3:0] & ~wmask);
    end
end
...
// int_real_input_h_V[8:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_real_input_h_V[8:0] <= 0;
    else if (ACLK_EN) begin
...
// int_fold_win_area_V[2:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_fold_win_area_V[2:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_FOLD_WIN_AREA_V_DATA_0)
            int_fold_win_area_V[2:0] <= (WDATA[31:0] & wmask) | (int_fold_win_area_V[2:0] & ~wmask);
    end
end
