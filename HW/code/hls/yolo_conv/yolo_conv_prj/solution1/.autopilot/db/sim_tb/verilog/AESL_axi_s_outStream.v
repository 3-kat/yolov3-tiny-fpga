...
`define TV_OUT_outStream_TDATA "./impl_rtl.yolo_conv_top.autotvout_outStream_V_data.dat"
`define EGRESS_STATUS_outStream_TDATA "./stream_egress_status_outStream_V_data.dat"
`define TV_OUT_outStream_TKEEP "./impl_rtl.yolo_conv_top.autotvout_outStream_V_keep_V.dat"
`define EGRESS_STATUS_outStream_TKEEP "./stream_egress_status_outStream_V_keep_V.dat"
`define TV_OUT_outStream_TSTRB "./impl_rtl.yolo_conv_top.autotvout_outStream_V_strb_V.dat"
`define EGRESS_STATUS_outStream_TSTRB "./stream_egress_status_outStream_V_strb_V.dat"
`define TV_OUT_outStream_TUSER "./impl_rtl.yolo_conv_top.autotvout_outStream_V_user_V.dat"
`define EGRESS_STATUS_outStream_TUSER "./stream_egress_status_outStream_V_user_V.dat"
`define TV_OUT_outStream_TLAST "./impl_rtl.yolo_conv_top.autotvout_outStream_V_last_V.dat"
`define EGRESS_STATUS_outStream_TLAST "./stream_egress_status_outStream_V_last_V.dat"
`define TV_OUT_outStream_TID "./impl_rtl.yolo_conv_top.autotvout_outStream_V_id_V.dat"
`define EGRESS_STATUS_outStream_TID "./stream_egress_status_outStream_V_id_V.dat"
`define TV_OUT_outStream_TDEST "./impl_rtl.yolo_conv_top.autotvout_outStream_V_dest_V.dat"
