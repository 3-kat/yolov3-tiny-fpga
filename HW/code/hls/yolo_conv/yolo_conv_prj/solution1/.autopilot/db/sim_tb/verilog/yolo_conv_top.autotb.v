...
`define AUTOTB_TVIN_inStream_V_data  "./c.yolo_conv_top.autotvin_inStream_V_data.dat"
`define AUTOTB_TVIN_inStream_V_keep_V  "./c.yolo_conv_top.autotvin_inStream_V_keep_V.dat"
`define AUTOTB_TVIN_inStream_V_strb_V  "./c.yolo_conv_top.autotvin_inStream_V_strb_V.dat"
`define AUTOTB_TVIN_inStream_V_user_V  "./c.yolo_conv_top.autotvin_inStream_V_user_V.dat"
`define AUTOTB_TVIN_inStream_V_last_V  "./c.yolo_conv_top.autotvin_inStream_V_last_V.dat"
`define AUTOTB_TVIN_inStream_V_id_V  "./c.yolo_conv_top.autotvin_inStream_V_id_V.dat"
`define AUTOTB_TVIN_inStream_V_dest_V  "./c.yolo_conv_top.autotvin_inStream_V_dest_V.dat"
`define AUTOTB_TVIN_outStream_V_data  "./c.yolo_conv_top.autotvin_outStream_V_data.dat"
`define AUTOTB_TVIN_outStream_V_keep_V  "./c.yolo_conv_top.autotvin_outStream_V_keep_V.dat"
`define AUTOTB_TVIN_outStream_V_strb_V  "./c.yolo_conv_top.autotvin_outStream_V_strb_V.dat"
`define AUTOTB_TVIN_outStream_V_user_V  "./c.yolo_conv_top.autotvin_outStream_V_user_V.dat"
`define AUTOTB_TVIN_outStream_V_last_V  "./c.yolo_conv_top.autotvin_outStream_V_last_V.dat"
`define AUTOTB_TVIN_outStream_V_id_V  "./c.yolo_conv_top.autotvin_outStream_V_id_V.dat"
`define AUTOTB_TVIN_outStream_V_dest_V  "./c.yolo_conv_top.autotvin_outStream_V_dest_V.dat"
`define AUTOTB_TVIN_output_ch_V  "./c.yolo_conv_top.autotvin_output_ch_V.dat"
...
`define AUTOTB_TVIN_fold_win_area_V  "./c.yolo_conv_top.autotvin_fold_win_area_V.dat"
`define AUTOTB_TVIN_inStream_V_data_out_wrapc  "./rtl.yolo_conv_top.autotvin_inStream_V_data.dat"
`define AUTOTB_TVIN_inStream_V_keep_V_out_wrapc  "./rtl.yolo_conv_top.autotvin_inStream_V_keep_V.dat"
`define AUTOTB_TVIN_inStream_V_strb_V_out_wrapc  "./rtl.yolo_conv_top.autotvin_inStream_V_strb_V.dat"
`define AUTOTB_TVIN_inStream_V_user_V_out_wrapc  "./rtl.yolo_conv_top.autotvin_inStream_V_user_V.dat"
`define AUTOTB_TVIN_inStream_V_last_V_out_wrapc  "./rtl.yolo_conv_top.autotvin_inStream_V_last_V.dat"
`define AUTOTB_TVIN_inStream_V_id_V_out_wrapc  "./rtl.yolo_conv_top.autotvin_inStream_V_id_V.dat"
`define AUTOTB_TVIN_inStream_V_dest_V_out_wrapc  "./rtl.yolo_conv_top.autotvin_inStream_V_dest_V.dat"
`define AUTOTB_TVIN_outStream_V_data_out_wrapc  "./rtl.yolo_conv_top.autotvin_outStream_V_data.dat"
`define AUTOTB_TVIN_outStream_V_keep_V_out_wrapc  "./rtl.yolo_conv_top.autotvin_outStream_V_keep_V.dat"
`define AUTOTB_TVIN_outStream_V_strb_V_out_wrapc  "./rtl.yolo_conv_top.autotvin_outStream_V_strb_V.dat"
`define AUTOTB_TVIN_outStream_V_user_V_out_wrapc  "./rtl.yolo_conv_top.autotvin_outStream_V_user_V.dat"
`define AUTOTB_TVIN_outStream_V_last_V_out_wrapc  "./rtl.yolo_conv_top.autotvin_outStream_V_last_V.dat"
`define AUTOTB_TVIN_outStream_V_id_V_out_wrapc  "./rtl.yolo_conv_top.autotvin_outStream_V_id_V.dat"
`define AUTOTB_TVIN_outStream_V_dest_V_out_wrapc  "./rtl.yolo_conv_top.autotvin_outStream_V_dest_V.dat"
`define AUTOTB_TVIN_output_ch_V_out_wrapc  "./rtl.yolo_conv_top.autotvin_output_ch_V.dat"
...
`define AUTOTB_TVIN_fold_win_area_V_out_wrapc  "./rtl.yolo_conv_top.autotvin_fold_win_area_V.dat"
`define AUTOTB_TVOUT_outStream_V_data  "./c.yolo_conv_top.autotvout_outStream_V_data.dat"
`define AUTOTB_TVOUT_outStream_V_keep_V  "./c.yolo_conv_top.autotvout_outStream_V_keep_V.dat"
`define AUTOTB_TVOUT_outStream_V_strb_V  "./c.yolo_conv_top.autotvout_outStream_V_strb_V.dat"
`define AUTOTB_TVOUT_outStream_V_user_V  "./c.yolo_conv_top.autotvout_outStream_V_user_V.dat"
`define AUTOTB_TVOUT_outStream_V_last_V  "./c.yolo_conv_top.autotvout_outStream_V_last_V.dat"
`define AUTOTB_TVOUT_outStream_V_id_V  "./c.yolo_conv_top.autotvout_outStream_V_id_V.dat"
`define AUTOTB_TVOUT_outStream_V_dest_V  "./c.yolo_conv_top.autotvout_outStream_V_dest_V.dat"
`define AUTOTB_TVOUT_outStream_V_data_out_wrapc  "./impl_rtl.yolo_conv_top.autotvout_outStream_V_data.dat"
`define AUTOTB_TVOUT_outStream_V_keep_V_out_wrapc  "./impl_rtl.yolo_conv_top.autotvout_outStream_V_keep_V.dat"
`define AUTOTB_TVOUT_outStream_V_strb_V_out_wrapc  "./impl_rtl.yolo_conv_top.autotvout_outStream_V_strb_V.dat"
`define AUTOTB_TVOUT_outStream_V_user_V_out_wrapc  "./impl_rtl.yolo_conv_top.autotvout_outStream_V_user_V.dat"
`define AUTOTB_TVOUT_outStream_V_last_V_out_wrapc  "./impl_rtl.yolo_conv_top.autotvout_outStream_V_last_V.dat"
`define AUTOTB_TVOUT_outStream_V_id_V_out_wrapc  "./impl_rtl.yolo_conv_top.autotvout_outStream_V_id_V.dat"
`define AUTOTB_TVOUT_outStream_V_dest_V_out_wrapc  "./impl_rtl.yolo_conv_top.autotvout_outStream_V_dest_V.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.yolo_conv_top.autotvout_outStream_V_data.dat", "r");
    fp2 = $fopen("./impl_rtl.yolo_conv_top.autotvout_outStream_V_data.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.yolo_conv_top.autotvout_outStream_V_data.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.yolo_conv_top.autotvout_outStream_V_data.dat\"!");
    else begin
        $display("Comparing rtl.yolo_conv_top.autotvout_outStream_V_data.dat with impl_rtl.yolo_conv_top.autotvout_outStream_V_data.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.yolo_conv_top.autotvout_outStream_V_keep_V.dat", "r");
    fp2 = $fopen("./impl_rtl.yolo_conv_top.autotvout_outStream_V_keep_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.yolo_conv_top.autotvout_outStream_V_keep_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.yolo_conv_top.autotvout_outStream_V_keep_V.dat\"!");
    else begin
        $display("Comparing rtl.yolo_conv_top.autotvout_outStream_V_keep_V.dat with impl_rtl.yolo_conv_top.autotvout_outStream_V_keep_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.yolo_conv_top.autotvout_outStream_V_strb_V.dat", "r");
    fp2 = $fopen("./impl_rtl.yolo_conv_top.autotvout_outStream_V_strb_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.yolo_conv_top.autotvout_outStream_V_strb_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.yolo_conv_top.autotvout_outStream_V_strb_V.dat\"!");
    else begin
        $display("Comparing rtl.yolo_conv_top.autotvout_outStream_V_strb_V.dat with impl_rtl.yolo_conv_top.autotvout_outStream_V_strb_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.yolo_conv_top.autotvout_outStream_V_user_V.dat", "r");
    fp2 = $fopen("./impl_rtl.yolo_conv_top.autotvout_outStream_V_user_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.yolo_conv_top.autotvout_outStream_V_user_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.yolo_conv_top.autotvout_outStream_V_user_V.dat\"!");
    else begin
        $display("Comparing rtl.yolo_conv_top.autotvout_outStream_V_user_V.dat with impl_rtl.yolo_conv_top.autotvout_outStream_V_user_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.yolo_conv_top.autotvout_outStream_V_last_V.dat", "r");
    fp2 = $fopen("./impl_rtl.yolo_conv_top.autotvout_outStream_V_last_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.yolo_conv_top.autotvout_outStream_V_last_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.yolo_conv_top.autotvout_outStream_V_last_V.dat\"!");
    else begin
        $display("Comparing rtl.yolo_conv_top.autotvout_outStream_V_last_V.dat with impl_rtl.yolo_conv_top.autotvout_outStream_V_last_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.yolo_conv_top.autotvout_outStream_V_id_V.dat", "r");
    fp2 = $fopen("./impl_rtl.yolo_conv_top.autotvout_outStream_V_id_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.yolo_conv_top.autotvout_outStream_V_id_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.yolo_conv_top.autotvout_outStream_V_id_V.dat\"!");
    else begin
        $display("Comparing rtl.yolo_conv_top.autotvout_outStream_V_id_V.dat with impl_rtl.yolo_conv_top.autotvout_outStream_V_id_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.yolo_conv_top.autotvout_outStream_V_dest_V.dat", "r");
    fp2 = $fopen("./impl_rtl.yolo_conv_top.autotvout_outStream_V_dest_V.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.yolo_conv_top.autotvout_outStream_V_dest_V.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.yolo_conv_top.autotvout_outStream_V_dest_V.dat\"!");
    else begin
        $display("Comparing rtl.yolo_conv_top.autotvout_outStream_V_dest_V.dat with impl_rtl.yolo_conv_top.autotvout_outStream_V_dest_V.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
