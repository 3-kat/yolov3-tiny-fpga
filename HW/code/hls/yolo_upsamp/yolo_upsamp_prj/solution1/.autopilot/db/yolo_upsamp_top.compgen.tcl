...
set ID 5
set hasByteEnable 0
set MemName yolo_upsamp_top_lbkb
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 6 \
			corename yolo_upsamp_top_CTRL_BUS_axilite \
			name yolo_upsamp_top_CTRL_BUS_s_axi \
			ports {$port_CTRL_BUS} \
			op interface \
			is_flushable 0 \ 
		} "
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler yolo_upsamp_top_CTRL_BUS_s_axi
}
