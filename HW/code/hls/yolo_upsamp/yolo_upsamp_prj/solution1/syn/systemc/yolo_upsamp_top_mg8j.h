...
// ==============================================================
#ifndef __yolo_upsamp_top_mg8j__HH__
#define __yolo_upsamp_top_mg8j__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(yolo_upsamp_top_mg8j) {
    ...
    SC_CTOR(yolo_upsamp_top_mg8j):  simcore_mac_1_U ("simcore_mac_1_U") {
