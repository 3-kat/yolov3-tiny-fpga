...
// ==============================================================
#ifndef __yolo_upsamp_top_mfYi__HH__
#define __yolo_upsamp_top_mfYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(yolo_upsamp_top_mfYi) {
    ...
    SC_CTOR(yolo_upsamp_top_mfYi):  simcore_mac_0_U ("simcore_mac_0_U") {
