...
if {[file isfile yolo_upsamp_top.autotvin.dat]} {
	file delete -force yolo_upsamp_top.autotvin.dat
}

if {[file isfile yolo_upsamp_top.autotvout.dat]} {
	file delete -force yolo_upsamp_top.autotvout.dat
}
