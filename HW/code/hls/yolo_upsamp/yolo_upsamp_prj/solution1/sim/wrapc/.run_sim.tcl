...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "yolo_upsamp_top.autotvin.dat"
	set constFileTvOut       "yolo_upsamp_top.autotvout.dat"
	set constFileHdlTvIn     "yolo_upsamp_top.autohdltvin.dat"
	set constFileHdlTvOut    "yolo_upsamp_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
