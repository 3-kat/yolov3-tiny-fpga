...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = yolo_acc_top
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = yolo_acc_top_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = yolo_conv_top
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = yolo_conv_top_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = yolo_max_pool_top
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = yolo_max_pool_top_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = yolo_upsamp_top
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = yolo_upsamp_top_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = yolo_yolo_top
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = yolo_yolo_top_0
END
